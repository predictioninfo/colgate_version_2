    ...
    ?>
        ...
        <div class=" mb-3">
            ...
            <div class="content-box">
                <div class="card">
                 <div class="card-body">
                    <form method="post" action="{{route('update-location-sixes')}}" class="form-horizontal" enctype="multipart/form-data">

                        @csrf
                        <div class="row">

                            <input type="hidden" name="id" value="{{$location_six->id}}">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    @foreach($regions as $region)
                                        <option value="{{$region->id}}" {{ $location_six->location_six_region_id ==  $region->id ? 'selected' : ''}}>{{$region->region_name}}</option>
                                    @endforeach
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <select class="form-control" name="area_id" id="area_id_edit">
                                        ...
                                        <option value="{{$area->id}}" {{ $location_six->location_six_area_id ==  $area->id ? 'selected' : ''}}>{{$area->area_name}}</option>
                                    @endforeach
                                    </select>
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <select class="form-control" name="territory_id" id="territory_id_edit">
                                        ...
                                        <option value="{{$territorie->id}}" {{ $location_six->location_six_territory_id ==  $territorie->id ? 'selected' : ''}}>{{$territorie->territory_name}}</option>
                                    @endforeach
                                    </select>
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <select class="form-control" name="town_id" id="town_id_edit">
                                        ...
                                        <option value="{{$town->id}}" {{ $location_six->location_six_town_id ==  $town->id ? 'selected' : ''}}>{{$town->town_name}}</option>
                                    @endforeach
                                    </select>
                                ...
                                <div class="col-md-4 form-group">
                                    <label>{{$location5}}{{__(' Name')}} <span class = "text-danger">*</span></label>
                                     <select class="form-control" name="db_house_id" id="db_house_id_edit" required>
                                        ...
                                        <option value="{{$db_housess->id}}" {{ $location_six->location_six_db_house_id ==  $db_housess->id ? 'selected' : ''}}>{{$db_housess->db_house_name}}</option>
                                    @endforeach
                                     </select>
                                </div>
                                ...
                                <div class="col-md-4">
                                        ...
                                        <label>{{ $location6 }}{{__(' Name')}} <span class = "text-danger">*</span> </label>
                                            ...
                                            <input type="text" name="location_six_name" id="location_six_id_edit" value="{{$location_six->location_six_location_six_name}}" required class="form-control">
                                        </div>
                                    </div>
