        ...
        <div class=" mb-3">
            ...
            <div class="card mb-0">
                <div class="card-header with-border">
                    <h1 class="card-title text-center">{{ $location->location4 }} {{ __('  List') }} </h1>
                    <ol id="breadcrumb1">
                        ...
                        <li><a href="#">List - {{ $location4 ?? 'location4' }} </a></li>
                    </ol>
                </div>
            </div>
            {{-- <div class="d-flex flex-row mt-3">
                ...
                <div class="ml-2">
                    <form method="post" action="{{route('bulk-delete-towns')}}" id="sample_form" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <h5 id="exampleModalLabel" class="modal-title">{{ $location4 }}</h5>
                            <button type="button" data-dismiss="modal" id="close" aria-label="Close" class="close"><i
                                    class="dripicons-cross"></i></button>
                        </div>

                        <div class="modal-body">
                            <form method="post" action="{{ route('add-towns') }}" class="form-horizontal"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="town_name" value="" required
                                                class="form-control">
                                        </div>
                                    </div>
            ...
            <div id="editLocationModal" class="modal fade" role="dialog">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="{{ route('loaction-fours') }}" class="form-horizontal"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="location4" value="" required
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 mt-4">
            ...
            <div class="content-box">
                ...
                <div class="table-responsive">
                    <table id="user-table" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            @php($i = 1)
                            @foreach ($towns as $townsValue)
                                <tr>

                                    <td>{{ $i++ }}</td>


                                    <td>{{ $townsValue->region_name }}</td>
                                    <td>{{ $townsValue->area_name }}</td>
                                    <td>{{ $townsValue->territory_name }}</td>
                                    <td>{{ $townsValue->town_name }}</td>
                                    @if ($edit_permission == 'Yes' || $delete_permission == 'Yes')
                                        <td>

                                                    @if ($edit_permission == 'Yes')
                                                        <a href="{{ route('edit-towns', ['id' => $townsValue->id]) }}"data-id="" class="btn edit" data-toggle="tooltip" title=" Edit "
                                                            data-original-title="Edit" > <i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                                    @endif
                                                    @if ($delete_permission == 'Yes')
                                                        <a href="{{ route('delete-towns', ['id' => $townsValue->id]) }}"
