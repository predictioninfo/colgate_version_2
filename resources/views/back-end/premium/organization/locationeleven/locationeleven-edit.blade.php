...
@section('content')
    ...
    ?>
        ...
        <div class="mb-3">
            ...
            @endforeach
            @foreach($locations_eleven as $location_eleven)
            <div class="content-box">
                <div class="card">
                 <div class="card-body">
                    <form method="post" action="{{route('update-location-elevens')}}" class="form-horizontal" enctype="multipart/form-data">

                        @csrf
                        <div class="row">

                            <input type="hidden" name="id" value="{{$location_eleven->id}}">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    @foreach($regions as $region)
                                        <option value="{{$region->id}}" {{ $location_eleven->location_eleven_region_id ==  $region->id ? 'selected' : ''}}>{{$region->region_name}}</option>
                                    @endforeach
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <select class="form-control" name="area_id" id="area_id_edit">
                                        ...
                                        <option value="{{$area->id}}" {{ $location_eleven->location_eleven_area_id ==  $area->id ? 'selected' : ''}}>{{$area->area_name}}</option>
                                    @endforeach
                                    </select>
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <select class="form-control" name="territory_id" id="territory_id_edit">
                                        ...
                                        <option value="{{$territorie->id}}" {{ $location_eleven->location_eleven_territory_id ==  $territorie->id ? 'selected' : ''}}>{{$territorie->territory_name}}</option>
                                    @endforeach
                                    </select>
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <select class="form-control" name="town_id" id="town_id_edit">
                                        ...
                                        <option value="{{$town->id}}" {{ $location_eleven->location_eleven_town_id ==  $town->id ? 'selected' : ''}}>{{$town->town_name}}</option>
                                    @endforeach
                                    </select>
                                ...
                                <div class="col-md-4 form-group">
                                    <label>{{$location5}}{{__(' Name')}} <span class = "text-danger">*</span></label>
                                     <select class="form-control" name="db_house_id" id="db_house_id_edit" required>
                                        ...
                                        <option value="{{$db_housess->id}}" {{ $location_eleven->location_eleven_db_house_id	 ==  $db_housess->id ? 'selected' : ''}}>{{$db_housess->db_house_name}}</option>
                                    @endforeach
                                     </select>
                                </div>
                                ...
                                <div class="col-md-4 form-group">
                                    <label>{{$location6}}{{__(' Name')}} <span class = "text-danger">*</span></label>
                                     <select class="form-control" name="location_six_id" id="location_six_id_edit" required>
                                        ...
                                        <option value="{{$location_six->id}}" {{ $location_eleven->location_eleven_six_id ==  $location_six->id ? 'selected' : ''}}>{{$location_six->location_six_location_six_name}}</option>
                                    @endforeach
                                     </select>
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>{{$location7}}{{__(' Name')}} <span class = "text-danger">*</span></label>
                                     <select class="form-control" name="location_seven_id" id="location_seven_id_edit" required>
                                        ...
                                        <option value="{{$location_seven->id}}" {{ $location_eleven->location_eleven_seven_id ==  $location_seven->id ? 'selected' : ''}}>{{$location_seven->location_seven_name}}</option>
                                    @endforeach
                                     </select>
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>{{$location8}}{{__(' Name')}} <span class = "text-danger">*</span></label>
                                     <select class="form-control" name="location_eight_id" id="location_eight_id_edit" required>
                                        ...
                                        <option value="{{$location_eight->id}}" {{ $location_eleven->location_eleven_eight_id ==  $location_eight->id ? 'selected' : ''}}>{{$location_eight->location_eights_name}}</option>
                                    @endforeach
                                     </select>
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>{{$location9}}{{__(' Name')}} <span class = "text-danger">*</span></label>
                                     <select class="form-control" name="location_nine_id" id="location_nine_id_edit" required>
                                        ...
                                        <option value="{{$location_nine->id}}" {{ $location_eleven->location_eleven_nine_id ==  $location_nine->id ? 'selected' : ''}}>{{$location_nine->location_nine_name}}</option>
                                    @endforeach
                                     </select>
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>{{$location10}}{{__(' Name')}} <span class = "text-danger">*</span></label>
                                     <select class="form-control" name="location_ten_id" id="location_ten_id_edit" required>
                                        <option selected>Please Selecte</option>
                                        @foreach($locations_ten as $location_ten)
                                        <option value="{{$location_ten->id}}" {{ $location_eleven->location_eleven_ten_id ==  $location_ten->id ? 'selected' : ''}}>{{$location_ten->location_ten_name}}</option>
                                    @endforeach
                                     </select>
                                </div>
                                ...
                                <div class="col-md-4">
                                        ...
                                        <label>{{ $location11 }}{{__(' Name')}} *</label>
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"> <i class="fa fa-location-arrow" aria-hidden="true"></i> </span>
                                            </div>
                                            <input type="text" name="location_eleven_name" value="{{ $location_eleven->location_eleven_name }}" required class="form-control">
                                        </div>
                                    </div>
