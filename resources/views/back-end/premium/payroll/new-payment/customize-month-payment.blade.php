        ...
        <table id="user-table" class="table table-bordered table-hover table-striped">
            ...
            <tbody>
                ...
                ############################################### attendance count code starts################################
                                $attendance_counts = Attendance::where('employee_id', '=', $new_payments_value->customize_monthly_employee_id)
                                ...
                                $attendance_work_hours_counts = Attendance::where('employee_id', '=', $new_payments_value->customize_monthly_employee_id)
                                    ->where('customize_attendance_month', '=', $last_month)
                                    ->where('customize_attendance_year', '=', $previous_month_year)
                                    ->where('check_in_out', '=', 1)
                                ...
                                if (
                                    Leave::where('leaves_employee_id', $new_payments_value->customize_monthly_employee_id)
                                        ->where('is_half', '=', 1)
                                    ...
                                    $employee_half_leaves = Leave::where('leaves_employee_id', $new_payments_value->customize_monthly_employee_id)
                                        ->where('is_half', '=', 1)
                                        ->where('leaves_status', '=', 'Approved')
                                        ->where('customize_leaves_month', '=', $last_month)
                                        ->where('customize_leaves_year', '=', $previous_month_year)
                                ...
                                if (
                                    ...
                                    $employee_half_leaves_to_get_no_of_attendences = Leave::where('leaves_employee_id', $new_payments_value->customize_monthly_employee_id)
                                        ->where('is_half', '=', 1)
                                        ->where('leaves_status', '=', 'Approved')
                                        ->where('customize_leaves_month', '=', $last_month)
                                        ->where('customize_leaves_year', '=', $previous_month_year)
                                    ...
                                    foreach ($employee_half_leaves_to_get_no_of_attendences as $employee_half_leaves_to_get_no_of_attendences_value) {
                                        ...
                                        if (
                                            Attendance::where('employee_id', $new_payments_value->customize_monthly_employee_id)
                                ...
                                if (
                                    ...
                                    $employee_leaves = Leave::where('leaves_employee_id', $new_payments_value->customize_monthly_employee_id)
                                        ->where(function ($query) {
                                            $query->where('is_half', 0)->orWhereNull('is_half');
                                        })
                                        ->where('leaves_status', '=', 'Approved')
                                ...
                                if (
                                    LateTime::where('late_time_employee_id', '=', $new_payments_value->customize_monthly_employee_id)
                                    ...
                                    $total_days_from_late_count_array = LateTime::where('late_time_employee_id', '=', $new_payments_value->customize_monthly_employee_id)
                                        ->where('customize_late_time_month', '=', $last_month)
                                        ->where('customize_late_time_year', '=', $previous_month_year)
                                ...
                                if (
                                    Travel::where('travel_com_id', Auth::user()->com_id)
                                        ->where('travel_employee_id', '=', $new_payments_value->customize_monthly_employee_id)
                                ...
                                $compensatory_leave_counts = CompensatoryLeave::where('compen_leave_employee_id', '=', $new_payments_value->customize_monthly_employee_id)
                                ...
                                if ($firstWorkingDate >= $monthStartDate && $firstWorkingDate <= $monthEndDate) {
                                    ...
                                    $attendance_counts_joining_date_wise = Attendance::where('employee_id', '=', $new_payments_value->customize_monthly_employee_id)
                                ...
                                $leaves = Leave::where('leaves_employee_id', $new_payments_value->customize_monthly_employee_id)
                                ->where('customize_leaves_month', '=', $last_month)
                                ->where('customize_leaves_year', '=', $previous_month_year)
                                ->where('leaves_status', 'Approved')->get();
                                ...
                                // Leave Attendence Count End
                                    ...
                                    if(Holiday::where('holiday_com_id',Auth::user()->com_id)->where('holiday_type','=','Other-Holiday')->where('customize_start_month',$last_month)->where('customize_start_year',$previous_month_year)->exists()){
                                    ...
                                    $holiday = Holiday::where('holiday_com_id',Auth::user()->com_id)->where('holiday_type','=','Other-Holiday')->where('customize_start_month',$last_month)->where('customize_start_year',$previous_month_year)->first();
                                 ...
                                 $all_house_rent = ($new_payments_value->gross_salary * $new_payments_value->salary_config_house_rent_allowance) / 100 ;
                                 $salary_config_medical_allowance = ($new_payments_value->gross_salary *$new_payments_value->salary_config_medical_allowance) / 100 ;
                                 $salary_config_conveyance_allowance = ($new_payments_value->gross_salary *
                ...
                <tr>
                    ...
                    <td>{{$new_payments_value->gross_salary ?? null }}</td>
                    <td>{{$employee_basic_salary_percentage_wise }}</td>

                    <td>

                        @if (FestivalBonus::where('festival_bonus_com_id', '=',
                        Auth::user()->com_id)->where('customize_festival_bonus_date_month', '=',
                        $last_month)->where('customize_festival_bonus_date_year',$previous_month_year)->exists())
                        ...
                        ->where('festival_payment_emp_id',$new_payments_value->customize_monthly_employee_id)
                        ->where('status',1)
                        ->where('festival_payment_customize_date', '=', $payment_month)
                        ->where('festival_payment_customize_date', '=', $payment_year)
                        ->exists())
                    ...
                    <?php
                                      ...
                                      //Incentive Start
                                       if(Incentive::where('incentive_com_id',Auth::user()->com_id)->where('incentive_emp_id',$new_payments_value->customize_monthly_employee_id)->where('customize_incentive_month',$last_month)->where('customize_incentive_year',$previous_month_year)->exists()){
                                        $incentive = Incentive::where('incentive_com_id',Auth::user()->com_id)->where('incentive_emp_id',$new_payments_value->customize_monthly_employee_id)->where('customize_incentive_month',$last_month)->where('customize_incentive_year',$previous_month_year)->first();
                                      ...
                                      //Prorata Start
                                        ...
                                        if(Prorata::where('prorata_com_id',Auth::user()->com_id)->where('prorata_emp_id',$new_payments_value->customize_monthly_employee_id)->where('customize_prorata_month',$last_month)->where('customize_prorata_year',$previous_month_year)->exists()){
                                            $prorata =
                                            Prorata::where('prorata_com_id',Auth::user()->com_id)->where('prorata_emp_id',$new_payments_value->customize_monthly_employee_id)->where('customize_prorata_month',$last_month)->where('customize_prorata_year',$previous_month_year)->first();
                                      ...
                                      if(OtherVariableOrOtherOverNightAllowance::where('other_variable_or_other_over_night_allowance_com_id',Auth::user()->com_id)->where('other_variable_or_other_over_night_allowance_emp_id',$new_payments_value->customize_monthly_employee_id)->where('customize_other_variable_or_other_over_night_allowance_month',$last_month)->where('customize_other_variable_or_other_over_night_allowance_year',$previous_month_year)->exists()){
                                        $ot_variable = OtherVariableOrOtherOverNightAllowance::where('other_variable_or_other_over_night_allowance_com_id',Auth::user()->com_id)->where('other_variable_or_other_over_night_allowance_emp_id',$new_payments_value->customize_monthly_employee_id)->where('customize_other_variable_or_other_over_night_allowance_month',$last_month)->where('customize_other_variable_or_other_over_night_allowance_year',$previous_month_year)->first();
                                      ...
                                      //OT Arrear Start
                                        ...
                                        if(OtArrear::where('ot_arrear_com_id',Auth::user()->com_id)->where('ot_arrear_emp_id',$new_payments_value->customize_monthly_employee_id)->where('customize_ot_arrear_month',$last_month)->where('customize_ot_arrear_year',$previous_month_year)->exists()){
                                        $ot_arrear =
                                        OtArrear::where('ot_arrear_com_id',Auth::user()->com_id)->where('ot_arrear_emp_id',$new_payments_value->customize_monthly_employee_id)->where('customize_ot_arrear_month',$last_month)->where('customize_ot_arrear_year',$previous_month_year)->first();
                                      ...
                                      //OT Snacks Allowance Start
                                        ...
                                        if(PerDaySnackAllowance::where('per_day_snack_allowance_com_id',Auth::user()->com_id)->where('per_day_snack_allowance_emp_id',$new_payments_value->customize_monthly_employee_id)->exists()){
                                        $snacks_allowance = PerDaySnackAllowance::where('per_day_snack_allowance_com_id',Auth::user()->com_id)->where('per_day_snack_allowance_emp_id',$new_payments_value->customize_monthly_employee_id)->first();
                                     ...
                                     //Other Deduction Start
                                        ...
                                        if(OtherDeduction::where('other_deduction_com_id',Auth::user()->com_id)->where('other_deduction_emp_id',$new_payments_value->customize_monthly_employee_id)->where('customize_other_deduction_month',$last_month)->where('customize_other_deduction_year',$previous_month_year)->exists()){
                                        $other_deduction =
                                        OtherDeduction::where('other_deduction_com_id',Auth::user()->com_id)->where('other_deduction_emp_id',$new_payments_value->customize_monthly_employee_id)->where('customize_other_deduction_month',$last_month)->where('customize_other_deduction_year',$previous_month_year)->first();
                                     ...
                                     //Other Arrear Deduction  Start
                                        ...
                                        if(OtherDeductionArrear::where('other_deduction_arrear_com_id',Auth::user()->com_id)->where('other_deduction_arrear_emp_id',$new_payments_value->customize_monthly_employee_id)->where('customize_other_deduction_arrear_month',$last_month)->where('customize_other_deduction_arrear_year',$previous_month_year)->exists()){
                                        $other_arrear_deduction =
                                        OtherDeductionArrear::where('other_deduction_arrear_com_id',Auth::user()->com_id)->where('other_deduction_arrear_emp_id',$new_payments_value->customize_monthly_employee_id)->where('customize_other_deduction_arrear_month',$last_month)->where('customize_other_deduction_arrear_year',$previous_month_year)->first();
                                     ...
                                     //OT Hour Start
                                        ...
                                        if(OverTimeHour::where('over_time_hour_com_id',Auth::user()->com_id)->where('over_time_hour_emp_id',$new_payments_value->customize_monthly_employee_id)->where('customize_over_time_hour_month',$last_month)->where('customize_over_time_hour_year',$previous_month_year)->exists()){
                                        $ot_hour =
                                        OverTimeHour::where('over_time_hour_com_id',Auth::user()->com_id)->where('over_time_hour_emp_id',$new_payments_value->customize_monthly_employee_id)->where('customize_over_time_hour_month',$last_month)->where('customize_over_time_hour_year',$previous_month_year)->first();
                                        $total_over_time_hour_for_the_employee = $ot_hour->total_over_time_hour;

                                        $over_time_hour_per_working_hour = $ot_hour->working_hour;

                                        $over_time_hour_per_hour_rate_for_the_employee = $new_payments_value->gross_salary/208;
                    ...
                    <?php
                                            ...
                                            if (
                                                Commission::where('commission_employee_id', '=', $new_payments_value->customize_monthly_employee_id)
                                                    ->where('customize_commission_month', '=', $last_month)
                                                    ->where('customize_commission_year', '=', $previous_month_year)
                                                    ->exists()
                                            ) {
                                                $employee_commissions_array = Commission::where('commission_employee_id', '=', $new_payments_value->customize_monthly_employee_id)
                                                    ->where('customize_commission_month', '=', $last_month)
                                                    ->where('customize_commission_year', '=', $previous_month_year)
                                            ...
                                            if (
                                                OtherPayment::where('other_payment_employee_id', '=', $new_payments_value->customize_monthly_employee_id)
                                                    ->where('customize_other_payment_month', '=', $last_month)
                                                    ->where('customize_other_payment_year', '=', $previous_month_year)
                                                    ->exists()
                                            ) {
                                                $other_payments_array = OtherPayment::where('other_payment_employee_id', '=', $new_payments_value->customize_monthly_employee_id)
                                                    ->where('customize_other_payment_month', '=', $last_month)
                                                    ->where('customize_other_payment_year', '=', $previous_month_year)
                                            ...
                                            if (
                                                Overtime::where('over_time_employee_id', '=', $new_payments_value->customize_monthly_employee_id)
                                                            ->where('customize_over_time_month', '=', $last_month)
                                                            ->where('customize_over_time_year', '=', $previous_month_year)
                                                    ->exists()
                                            ) {
                                                $over_times = Overtime::where('over_time_employee_id', '=', $new_payments_value->customize_monthly_employee_id)
                                                     ->where('customize_over_time_month', '=', $last_month)
                                                     ->where('customize_over_time_year', '=', $previous_month_year)
                    ...
                    <?php
                                        ...
                                        if(Lunch::where('lunch_com_id', Auth::user()->com_id)->where('lunch_emp_id',$new_payments_value->customize_monthly_employee_id)->where('customize_lunch_month',$last_month)->where('customize_lunch_year',$previous_month_year)->exists()){

                                        $lunch_bill_deduction = Lunch::where('lunch_com_id',Auth::user()->com_id)->where('lunch_emp_id',$new_payments_value->customize_monthly_employee_id)->where('customize_lunch_month',$last_month)->where('customize_lunch_year',$previous_month_year)->first('lunch_bill');
                    ...
                    <td>
                        ...
                        $new_payments_value->customize_monthly_employee_id)->where('loans_remaining_installments', '>',
                        0)->exists())
                        @php(
                    ...
                    $bank_accounts = BankAccount::where('bank_account_com_id', Auth::user()->com_id)
                                            ->where('bank_account_employee_id', $new_payments_value->customize_monthly_employee_id)
                                            ->first();
                     ?>
                    <td>
                        ...
                        <form method="post" action="{{ route('makecustomizepayments') }}" class="form-horizontal btn"
                            ...
                            <input type="hidden" name="pay_slip_com_id"
                                value="{{ $new_payments_value->customize_monthly_com_id }}">
                            <input type="hidden" name="pay_slip_employee_id"
                                value="{{ $new_payments_value->customize_monthly_employee_id }}">
                            ...
                            <input type="hidden" name="pay_slip_year"
                                value="{{ $new_payments_value->attendance_year }}">
                            ...
                            $new_payments_value->customize_monthly_employee_id)->where('customize_statutory_deduc_month',
                            '=', $last_month)->where('customize_statutory_deduc_year', '=',
                            $previous_month_year)->exists())
                            @php(
                            ...
                            <input type="hidden" name="pay_slip_prorata" value="{{ $prorata_for_the_employee + 0 }}">
                            ...
                            <input type="hidden" name="over_time_allowance" value="{{ $over_time_allowance + 0 }}">

                            <input type="hidden" name="pay_slip_deduction_for_unauthorised_leave" value="{{ $deduction_for_unauthorised_leave = ((($new_payments_value->gross_salary*12)/365)*($total_number_of_days_of_the_month -
                            ($total_working_days+$holidays_date))) }}">
                            ...
                            <input type="hidden" name="pay_slip_net_salary"
                                value="{{ $net_salary = $new_payments_value->gross_salary + $incentive_for_the_employee + $prorata_for_the_employee +  $ot_arrear_for_the_employee + $snack_allowance+$over_time_allowance}}">
                            ...
                            <input type="hidden" name="pay_slip_leave_days" value="{{$overlappingLeaveDays }}">
                    ...
                    <div class="modal-dialog payment-slip-view">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                $new_payments_value->customize_monthly_employee_id)->whereMonth('increment_date',$last_month)->whereYear('increment_date',$previous_month_year)->first())
                                <?php

                                            $incrementData = IncrementSalaryHistory::where('inc_sal_his_com_id', Auth::user()->com_id)
                                                ->where('emp_id', $new_payments_value->customize_monthly_employee_id)
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="profile-view">
                                            ...
                                            <div class="profile-info">
                                                ...
                                                {{$new_payments_value->customize_monthly_employee_id}}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <dl>
                                            ...
                                            <dd> {{ $over_time_hour_per_hour_rate_for_the_employee }} </dd>
                                            ...
                                            <dd> {{ $netSalary-$deduction - $all_tax_deduction -
                                ...
                                $new_payments_value->customize_monthly_employee_id)->where('is_active' ,
                                1)->whereNotNull('active_date')->first())
                                <?php

                                                $userActiveDate = User::where('com_id', Auth::user()->com_id)
                                                    ->where('id', $new_payments_value->customize_monthly_employee_id)
                                                    ->first();
                                            ...
                                            $holidayDataCount = count($holidayData);
                                                ...
                                                $attendanceData = [];
                                                foreach ($days as $day) {
                                                    $data = Attendance::where('employee_id', $new_payments_value->customize_monthly_employee_id)
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <dl>
                                            ...
                                            <dd> {{$total_number_of_days_of_the_month - $total_working_days }} </dd>

                                            <dd> <b> Gross Salary:</b></dd>
                                            <dd> {{ $new_payments_value->gross_salary }} </dd>
                                            ...
                                            <dd> <b> Snakcs Allowance: </b></dd>
                                            <dd> {{ ($snacks_allowance_for_the_employee * $all_attendances_of_the_month)
                                                + 0 }} </dd>

                                            <dd> <b> Overnight Allowance/Other Variables </b></dd>
                                            <dd> {{ $over_time_allowance
                                                + 0 }} </dd>
                                ...
                                @elseif(User::where('id',
                                $new_payments_value->customize_monthly_employee_id)->whereNotNull('inactive_date')->first())
                                <?php
                                    ...
                                    <div class="col-md-12">
                                        <dl>
                                            ...
                                            <dd> {{$total_number_of_days_of_the_month -
                                                ($total_working_days+$holidays_date)}} </dd>
