...
<body>
    <section class="main-contant-section">
        ...
        $last_month_date_year = $data['last_month_date_year'];
        $last_month = $data['last_month'];////////////the payment month
        $date_wise_day_name = $data['date_wise_day_name'];
        $previous_month_year = $data['previous_month_year'];////////////the payment month's year
        ...
        <div class="table-responsive mt-4">
            <table id="user-table" class="table table-bordered table-hover table-striped"
                ...
                <tbody>
                    ...
                    @foreach ($data['new_payments'] as $new_payments_value)
                    ...
                    <tr>
                        ...
                        <td>{{ $netSalary = number_format((float)$netSalary+$bonus_amount, 2, '.', '')}}</td>
