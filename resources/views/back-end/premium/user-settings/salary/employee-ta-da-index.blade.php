    ...
    <section class="main-contant-section">
        ...
        <div class=" mb-3">
            ...
            <div class="card mb-0">
                <div class="card-header with-border">
                    <h1 class="card-title text-center"> {{ __('TA/DA List') }} </h1>
                    <ol id="breadcrumb1">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h5 id="exampleModalLabel" class="modal-title">{{_('Add TA/DA')}}</h5>
                            <button type="button" data-dismiss="modal" id="close" aria-label="Close" class="close"><i class="dripicons-cross"></i></button>
                        </div>

                        <div class="modal-body">
                            <form method="post" action="{{route('add-employee-transport-allowances')}}" class="form-horizontal" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 form-group">
                                        <label>TA/DA</label>
                                        <input type="text" name="transport_allowance" placeholder="10000" class="form-control" value="">
                                    </div>
        ...
        <div class="table-responsive">
            <table id="user-table" class="table table-bordered table-hover table-striped">
                ...
                <tbody>
				        @php($i=1)
                        @foreach($transport_allowances as $transport_allowances_value)
                        <tr>
                            <td>{{$i++}}</td>
                            <td>{{$transport_allowances_value->transport_allowance}}</td>
                            ...
                            <td>
                                ...
                                <a href="{{route('delete-employee-transport-allowances',['id'=>Session::get('employee_setup_id')])}}" class="btn btn-danger delete-post"class="btn btn-danger delete-post"class="btn btn-danger delete-post" data-toggle="tooltip" title="Delet"  data-original-title="Delet"> <i class="fa fa-trash-o" aria-hidden="true"></i></a>
                            </td>
                            @endif
                        </tr>
                        @endforeach
                    ...
                    <form method="post" id="edit_form" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="transport_allowance" id="transport_allowance" class="form-control" value="">
                            </div>
  ...
  $.ajaxSetup({
      ...
      $('#user-table').DataTable({
             ...
             $('.editModal').on('click', function () {
                ...
                $.ajax({
                    type:"POST",
                    url: 'employee-transport-allowance-by-id',
                    data: { id: id },
                    dataType: 'json',
                    ...
                    $('#id').val(res.id);
                    $('#transport_allowance').val(res.transport_allowance);
                }
                });
            });
          ...
          $('#edit_form').submit(function(e) {
                ...
                $.ajax({
                    type:'POST',
                    url: `/update-employee-transport-allowance`,
                    data: formData,
                    contentType: false,
                    processData: false,
                    success: (response) => {
