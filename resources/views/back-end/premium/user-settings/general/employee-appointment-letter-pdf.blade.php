...
if($joinig_day == '৩১'){echo $joinig_day.'শে '.$joinig_month." ".$joinig_year." ইং";}
 ...
 ?>
                ...
                <?php
if($day_expiry_bn == '১'){echo $day_expiry_bn .'লা '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '২'){echo $day_expiry_bn .'ই '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '৩'){echo $day_expiry_bn .'ই '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '৪'){echo $day_expiry_bn .'ই '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '৫'){echo $day_expiry_bn .'ই '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '৬'){echo $day_expiry_bn .'ই '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '৭'){echo $day_expiry_bn .'ই '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '৮'){echo $day_expiry_bn .'ই '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '৯'){echo $day_expiry_bn .'ই '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '১০'){echo $day_expiry_bn .'ই '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '১১'){echo $day_expiry_bn .'ই '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '১২'){echo $day_expiry_bn .'ই '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '১৩'){echo $day_expiry_bn .'ই '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '১৪'){echo $day_expiry_bn .'ই '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '১৫'){echo $day_expiry_bn .'ই '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '১৬'){echo $day_expiry_bn .'ই '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '১৭'){echo $day_expiry_bn .'ই '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '১৮'){echo $day_expiry_bn .'ই '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '১৯'){echo $day_expiry_bn .'শে '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '২০'){echo $day_expiry_bn .'শে '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '২১'){echo $day_expiry_bn .'শে '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '২২'){echo $day_expiry_bn .'শে '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '২৩'){echo $day_expiry_bn .'শে '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '২৪'){echo $day_expiry_bn .'শে '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '২৫'){echo $day_expiry_bn .'শে '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '২৬'){echo $day_expiry_bn .'শে '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '২৭'){echo $day_expiry_bn .'শে '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '২৮'){echo $day_expiry_bn .'শে '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '২৯'){echo $day_expiry_bn .'শে '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '৩০'){echo $day_expiry_bn .'শে '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
if($day_expiry_bn == '৩১'){echo $day_expiry_bn .'শে '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
...
<div class=" appointment-letter">
                ...
                <span style="font-size:12px;"> {{ $employee_value->first_name ?? null}} {{$employee_value->last_name ??
                    null}}</span><br>
                <span style="font-size:12px;"> {{ $employee_value->address ?? null}}</span>
                <br>
        </p>
   ...
   @endif </span> under the following terms and conditions:
    ...
    <ol style="padding-left:15px; list-style-type: english;padding-top:-10px; font-size:13px;">
        ...
        <li><span style="font-weight:bold;"> Remuneration and benefits: <br></span><br> <span
                style="margin-left: 3%; margin-right:50%">
                @if($employee_value->salary_type == "Monthly")
                ...
                @endif
                @if($employee_value->salary_type == "Hourly")
                <p> Your payment will be {{$employee_value->per_hour_rate}} TK per hour. </p><br>
                @endif
        </li>
        ...
        <li>This contract will be valid till
            ...
            <?php
if($day_expiry == '1'){echo $day_expiry .'st '.$month_expiry ." ".$year_expiry ."";}
if($day_expiry == '2'){echo $day_expiry .'nd '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '3'){echo $day_expiry .'rd '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '4'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '5'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '6'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '7'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '8'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '9'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '10'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '11'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '12'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '13'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '14'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '15'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '16'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '17'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '18'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '19'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '20'){echo $day_expiry .'th'.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '21'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '22'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '23'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '24'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '25'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '26'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '27'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '28'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '29'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '30'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
if($day_expiry == '31'){echo $day_expiry .'th '.$month_expiry ." ".$year_expiry ." ";}
 ...
 ?>
   ...
   ?>
                ...
                <ol style="padding-left:15px; list-style-type: english;padding-top:-10px; font-size:13px;">
                    ...
                    <li>You will be designated as <span style="font-weight:bold;font-size:12px;">
                            “{{$employee_value->userdesignation->designation_name}}”</span> and you will be posted to
                        Gazipur and depending on business needs, you may be transferred to anywhere in Bangladesh.</li>
                    <br>
                    <li><span style="font-weight:bold;"> Remuneration and benefits: <br></span><br> <span
                            style="margin-left: 3%; margin-right:50%">
                            ...
                            <div style="padding-left: 5%">
                                <p>
                                    ...
                                    BDT <span style="padding-left:20%;">
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $house_tot =
                                        number_format((float)$house , 0, '.', '')}}{{__('.00')}} &nbsp;
                                    </span><br>@endif

                                    @if($medical) Medical allowance
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;BDT
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span
                                        style="margin-left:20%;">{{$medical_tot= number_format((float)$medical , 0, '.',
                                        '')}}{{__('.00')}} &nbsp; </span> <br> @endif
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="margin-left:20%;">
                                        {{$lunch = $emp->allowance_head_ammount ?? '1000'}}{{__('.00')}} &nbsp; </span>
                                    <br>@endif @endforeach
                                    {{--
                                    @if($employee_value->transport_allowance) Transport Allowance
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    BDT &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="margin-left:20%;">
                                        {{$transport = $employee_value->transport_allowance ?? 0}}{{__('.00')}}&nbsp;
                                    </span> <br> @endif --}}

                                    @if($employee_value->mobile_bill) Mobile allowance
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    BDT &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="margin-left:20%;">
                                        {{$mobile = $employee_value->mobile_bill ?? 0}} {{__('.00')}}&nbsp; </span> <br>
                                    @endif

                                    @foreach($employee_allowances as $emp)@if($emp->allowance_head_id == 12) Special
                                    allowance
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;BDT
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="margin-left:20%;">{{
                                        $special = $emp->allowance_head_ammount ?? 0}}{{__('.00')}} &nbsp; </span> <br>
                                    @endif @endforeach
                                    @foreach($employee_allowances as $emp)@if($emp->allowance_head_id == 19) Internet
                                    Bill
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp; &nbsp; &nbsp;BDT &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span
                                        style="margin-left:20%;"> {{ $Internet = $emp->allowance_head_ammount ??
                                        0}}{{__('.00')}} &nbsp; </span> <br>@endif @endforeach
                                    ...
                                    <span style="font-weight:bold;"> Total &nbsp; salary
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;BDT
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$medical_tot+$house_tot
                                        +$basic_tot +$transport+$mobile+$lunch+$special+$Internet }}{{__('.00')}}
                                        &nbsp;</span>
                    ...
                    <li> You shall conform to all Rules and Regulations in force from time to time and shall carry out
                        all other lawful orders/instructions/directions of your Superiors as are given to you in
                        connection with day-to-day discharge of your duties while in the Employment of our client.</li>
                    <br>
                    <li> Your contract of service shall be subject to termination with one-month notice from either side
                        or monetary value. </li><br>
                    </span><br><br><br><br>
                    <p style="font-size: 10px;text-align:center;">1 | Page | Prediction Learning Associates Ltd., 365/9,
                        Lane 06, Baridhara DOHS, Dhaka -1206, Bangladesh;<br>
                        Tel: +88028413439; +8801713 -334 874; www.predictionla.com, email: info@predictionla.com</p>
                    <br><br><br>
                    <img style="width:170px;" src="{{asset('idcard/pla_logo.png')}}"> <br>
...
$internet_allowance = $emp->allowance_head_ammount ?? 0;
 ...
 $per_hour_rate = Bengali_DTN($employee_value->per_hour_rate );
  ...
  $tot_ban = $basic_salay+$house_rent+$medical_allowence +$mobile+$lunch_allowance+$special_allowance+$internet_allowance ;
 ...
 ?>
                            ...
                            <ol style="padding-left:15px">
                                <li><span style="font-weight:bold;"> কর্মস্থলঃ প্রেডিকশন লার্নিং এসোসিয়েটস লিঃ
                                        (পি.এল.এ.)</span> এর নিয়োগপ্রাপ্ত অস্থায়ী শ্রমিক হিসেবে আপনি প্রতিষ্ঠানের
                                    সম্মানিত গ্রাহক অথবা গ্রাহক কোম্পানির নির্ধারিত এলাকায় দ্বায়িত্ব প্রাপ্ত হবেন ।
                                </li>
                                <li><span style="font-weight:bold;"> পারিশ্রমিক ও সুবিধাদিঃ </span><br> <span
                                        style="margin-left: 3%; margin-right:50%">
                                        @if($employee_value->salary_type == "Monthly")
                ...
                <span style="margin-left: 3%;"><span style="font-size: 16px;font-weight:bold;">গ) (টি এ/ডি এ) <span
                            style="font-size: 14px;">
                            আপনার দৈনিক খরচ বাবদ {{ $transport ?? $ta_da }} টাকা করে দেওয়া হবে যা শুধুমাত্র আপনার
                            কর্মদিনের উপস্থিতির উপর সম্পুর্ণ নির্ভর করে প্রদান করা হবে। কোনদিন অনুপস্থিত থাকলে বা ছুটিতে
                            থাকলে উক্ত দিনের কোন ভাতা দেওয়া হবে না।
                            <br>
                            @endif
                            @if($employee_value->salary_type == "Hourly")
                            আপনার পেমেন্ট প্রতি ঘন্টায় {{$per_hour_rate }} টাকা হারে প্রদান করা হবে ।
                            @endif
        </li>
        @if($employee_value->salary_type == "Monthly")
        <li><span style="font-size: 15px; font-weight:bold;"> চাকুরির অবসানঃ</span> অত্র প্রতিষ্ঠান আপনাকে ৩০ (ত্রিশ)
            ...
            কালীন সময়ের যাবতীয় পাওনা পরিশোধ স্বাপেক্ষে চাকুরি থেকে অব্যাহতি নিতে পারেন ।
            @endif </li><br>
...
if($day_expiry_bn == '৩১'){echo $day_expiry_bn .'শে '.$month_expiry_bn ." ".$year_expiry_bn." ইং";}
 ...
 ?>
                ...
                <ol style="padding-left:15px">
                    <li><span style="font-weight:bold;"> কর্মস্থলঃ প্রেডিকশন লার্নিং এসোসিয়েটস লিঃ (পি.এল.এ.)</span> এর
                        নিয়োগপ্রাপ্ত অস্থায়ী শ্রমিক হিসাবে আপনি প্রতিষ্ঠানের সম্মানিত গ্রাহক কোম্পানির ফ্যাক্টরি অফিসে
                        দ্বায়িত্ব প্রাপ্ত হবেন । </li>
                    <li><span style="font-weight:bold;"> পারিশ্রমিক ও সুবিধাদিঃ </span><br> <span
                            style="margin-left: 3%; margin-right:50%">
                            ক) <span style="font-weight:bold;font-size: 15px;"> মাসিক মোট বেতনঃ </span><br>
                            <p style="padding-left:10%;">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp; :
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span
                                    style="margin-left:20%;"> {{$basic_salary_float_round_bangla }}{{__('.০০')}}
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; টাকা </span> <br> @endif
                                @if($house_rent) বাড়ি ভাড়া &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; :
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span
                                    style="margin-left:20%;"> {{$medical_salary_float_round_bangla ??
                                    null}}{{__('.০০')}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; টাকা </span> <br>@endif
                                @foreach($employee_allowances as $emp) @if($emp->allowance_head_id == 16) দৈনিক
                                ভাতা&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; :
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span
                                    style="margin-left:20%;"> {{$lunch_allowance_amount ??
                                    $lunch}}{{__('.০০')}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; টাকা </span> <br>
                                @endif @endforeach
                                {{--
                                @if($transport_allowance) যাতায়াত ভাতা&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                @foreach($employee_allowances as $emp) @if($emp->allowance_head_id == 12) বিশেষ ভাতা
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                : <span style="padding-left:40px;">
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{
                                    $special_allowance_amount?? $special}}{{__('.০০')}}
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; টাকা </span><br> @endif @endforeach
                                @foreach($employee_allowances as $emp) @if($emp->allowance_head_id == 19) ইন্টারনেট বিল
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                : <span style="padding-left:40px;">
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{
                                    $internet_allowance_amount?? 0}}{{__('.০০')}}
    ...
    <li><span style="font-size: 15px; font-weight:bold;"> চাকুরির অবসানঃ</span> অত্র প্রতিষ্ঠান আপনাকে ৩০ (ত্রিশ) দিনের
        লিখিত পূ্র্ব নোটিশ প্রদান করত: বা তাৎক্ষনিক ভাবে উক্ত নোটিশ কালীন সময়ের যাবতীয় পাওনা পরিশোধ স্বাপেক্ষে আপনার
        চাকুরির অবসান ঘটাতে পারে । আপনিও চাইলে ৩০ (ত্রিশ) দিনের পূ্র্ব নোটিশ প্রদান স্বাপেক্ষে বা উক্ত নোটিশ কালীন সময়ের
        যাবতীয় পাওনা পরিশোধ স্বাপেক্ষে চাকুরি থেকে অব্যাহতি নিতে পারেন । </li><br>
    <li><span style="font-size: 15px; font-weight:bold;">চাকুরির হতে ডিসচার্জঃ </span> কোন রেজিষ্টার্ড চিকিৎসক কর্তৃক
        প্রত্যয়িত আপনার শারিরিক বা মানসিক অক্ষমতা বা অব্যাহত ভগ্ন স্বাস্থ্যের কারণে যে কোন সময়ে আপনাকে চাকুরি হতে
        ডিসচার্জ করা যেতে পারে ।</li>
    <li> <span style="font-size: 15px; font-weight:bold;">চাকুরির হতে বরখাস্তঃ </span><br>
        <span style="margin-left: 3%;">
            ক) আপনি, যদি কোন প্রকার অসদাচরণের অপরাধে দোষী সাব্যস্ত হন অথবা আপনি যদি কোন ফৌজদারী অপরাধের জন্য দন্ডপ্রাপ্ত
            হন সেক্ষেত্রে আপনাকে বিনা নোটিশে বা নোটিশের পরিবর্তে বিনা বেতনে চাকুরি হতে বরখাস্ত করা যেতে পারে ।
        </span><br>
        <span style="margin-left: 3%;">
            খ)আপনি, যদি রাষ্ট্রদ্রোহী অথবা জঙ্গিবাদ সংশ্লিষ্ট কাজে লিপ্ত থাকেন অথবা থাকার প্রমাণ পাওয়া যায়, সেক্ষেত্রে
            আপনাকে বিনা নোটিশে চাকুরি হতে বরখাস্ত করা যেতে পারে ।
        </span><br>
        <span style="margin-left: 3%;">
            গ) এছাড়াও আপনার পক্ষ থেকে কোনরূপ ব্যর্থতা এবং সময়মত দায়িত্ব ও কর্তব্য পালন না করলে আপনাকে চাকুরি হতে বরখাস্ত
            সহ আইনানুগ ব্যবস্থা গ্রহণ করত: বরখাস্ত করতে পারবে ।
        </span>
        <br><br><br><br>
        <p style="font-size: 10px;text-align:center;">1 | Page | Prediction Learning Associates Ltd., 365/9, Lane 06,
            Baridhara DOHS, Dhaka -1206, Bangladesh;<br>
    ...
    <li><span>
            সকল বিধি ও বিধিমালা, নীতিমালা, পদ্ধতি যা আপনার নিয়োগ পত্রে উল্লেখ তা বর্তমানে কার্যকর বলে গণ্য হবে এবং
            সেগুলো প্রতিষ্ঠানের বিবেচনায় যে কোন সময় পরিবর্তিত হতে পারে । তবে এই রকম পরিবর্তন হলে আপনাকে পূর্বে অবহিত করা
            হবে ।
        </span></li>
    <li><span>
            অত্র প্রতিষ্ঠান বা গ্রাহক কেম্পানীর যে সকল সম্পদ ও পরিসম্পদ সমূহ যেগুলো কর্মরত অবস্থায় আপনার অধীনে থাকবে
            যেমন, ব্যাগ, মোবাইল সেট, মোবাইল সিম, ক্যাটালগ, ইত্যাদি অথবা অন্য কোন দলিল ও তথ্যাদি, অত্র নিয়োগের পরিসমাপ্তি
            হলে সেগুলো আপনি কর্তৃপক্ষকে ফেরত দিতে বাধ্য
            থাকিবেন ।
        </span></li>
    <li><span>
            এ নিয়োগের অন্যান্য শর্তাদি অত্র প্রতিষ্ঠানের বিধি ও প্রবিধান এবং শ্রম আইন অনুযায়ী পরিচালিত হবে ।
