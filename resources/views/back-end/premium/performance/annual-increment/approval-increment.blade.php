                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" class="btn edit" data-target="#addApprovalIncrement{{ $users_value->id }}" data-id="" data-toggle="modal" title="Increment Approval"
                                data-original-title="Increment" > <i class="fa fa-check" aria-hidden="true"></i> </a>

                            <a href="#" class="btn edit" data-target="#addApprovalCustomizeIncrement{{ $users_value->id }}" data-id="" data-toggle="modal" title="Customize Increment Approval"
                                data-original-title="Increment" > <i class="fa fa-check" aria-hidden="true"></i> </a>
                                ...
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header">
                                            <h5 id="exampleModalLabel" class="modal-title">{{__('Increment')}}</h5>
