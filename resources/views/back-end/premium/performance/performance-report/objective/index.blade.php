                            ...
                            <div class="tab-content">
                                ...
                                <div id="orange" class="b-tab active">
                                    <div id="" class="tabcontent">
                                        <h1 class="text-center"> Objective Report </h1>
                                        <div class="">
                                            <ul class="btn-tasks">
                                                {{-- <li class="dropdown">
                                                ...
                                                <li class="dropdown">
                                                    <a href="{{ route('download-performance-report') }}"
                                                        class="btn-grad btn" title="Download PDF" data-toggle="tooltip"
                                            ...
                                            <div id="form" style="display: block;">
                                                ...
                                                <form action="{{ route('performance-report') }}" method="GET"
                                            ...
                                            <div class="table-responsive mt-4">
                                                <table id="user-table"
                                                    ...
                                                    <tbody id="allData">
                                                        @php($i = 1)
                                                        @foreach ($objective_employee as $value)
                                                            <tr>
                                                                <td>{{ $i++ }}</td>
                                                                <td>{{ $value->userdepartmentfromobjective->department_name ?? null }}
                                                                </td>
                                                                <td>{{ $value->userdesignationfromobjective->designation_name ?? null }}
                                                                </td>
                                                                <td>{{ ucfirst($value->userfromobjective->first_name ?? '') }}
                                                                    {{ ucfirst($value->userfromobjective->last_name ?? '') }}
                                                                </td>
                                                                <td>{{ date('Y-d-m', strtotime($value->objective_date)) }}
                                                                </td>
                                                                <td>
                                                                    <a style="padding-right: 5px"
                                                                        href="{{ route('single-employee-performance-report-download', $value->id) }}"
                                                                        class="btn edit" data-toggle="tooltip"
                                                                        title="Download PDF"> <i
                                                                            class="fa fa-file-pdf-o"></i></a>



                                                                    <a href="{{ route('single-employee-performance-report-preview', $value->id) }}"
                                ...
                                <div id="incomplete_form" class="b-tab">
                                    <div class="content-box">
                                        <h1>hi 3</h1>
                                    </div>
                                </div>
