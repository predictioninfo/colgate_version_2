        ...
        <div class="card mb-0">
            <div class="card-header with-border">
                ...
                <ol id="breadcrumb1">
                    ...
                    <li><a href="{{ route('indicators') }}"><span
                        ...
                        <div class="table-responsive">
                            ...
                            <form action="{{ route('update-development-plans', $userName->id) }}" method="POST"
                                ...
                                <table class="form-table" id="development_plan">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <textarea class="code" id="customFieldValue"
                                                    name="meassure_of_success[]"
                                                    placeholder="Meassure Of Success">{{ $value->development_meassure_of_success }} </textarea>
                                            </td>
                                            <td> <textarea class="code" id="customFieldValue" name="action_taken[]"
                                                    value="" placeholder="Action Taken"
                                                    readonly>{{ $value->development_action_taken ?? ''}}  </textarea>
                                            </td>
                                ...
                                <div class="form-group mt-4">
                                    ...
                                    <input type="submit" name="status" class="btn btn-grad"
                                        value="{{__('Approve')}}" />
                                    ...
                                    <button type="button" class="edit-btn btn btn-grad mr-2" data-toggle="modal"
                                     ...
                                     <a style="" href="{{ route('details-development-plans-pdf',$userName->id) }}"
    ...
    $(document).ready(function() {
            $(".addOB").click(function() {
                ...
                <tr valign="top">
                    ...
                    <td> <input  class="code" id="customFieldValue" name="action_taken[]" value="" placeholder="Action Taken"
