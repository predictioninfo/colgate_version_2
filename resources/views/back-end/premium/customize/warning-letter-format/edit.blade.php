...
<section class="main-contant-section">
    ...
    <div class="employee-basic-information">
        ...
        <form method="POST" action="{{ route('warning-letter-format-edits', ['id' => $warnings->id]) }}"
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" placeholder="Letter Subject"
                                                    ...
                                                    value="{!! strip_tags($warnings->warning_letter_format_subject) ?? null !!}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="">
                                            <textarea name="warning_letter_format_body" id="description" cols="30"
                                                rows="5"
                                                placeholder="Writing Somthing....">{!! strip_tags($warnings->warning_letter_format_body) ?? null !!}</textarea>
                                            </textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <img id="blah" src="{{ asset($warnings->warning_letter_format_signature) }}"
                                            ...
                                            <div class="input-group">
                                                <select name="employee_id" id="employment_type" class="form-control"
                                                    ...
                                                    <option value="{{ $employee->id }}" {{ $employee->id ==
                                                        $warnings->warning_letter_format_signature_emp_id ? 'selected' :
                                                        '' }}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select name="footer_id" class="form-control">
                                                    ...
                                                    <option value="{{ $footer->id ?? null }}" {{ $footer->id ==
                                                        $warnings->footer_id ? 'selected' : ''}}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <textarea name="warning_letter_format_extra" id="" cols="30" rows="5"
                                                    placeholder="Writing Somthing....">{!! strip_tags($warnings->warning_letter_format_extra_feature) !!}</textarea>
                                            </div>
                                        </div>
                                    </div>
