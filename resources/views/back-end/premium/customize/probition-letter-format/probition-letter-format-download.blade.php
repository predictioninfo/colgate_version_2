...
?>
    ...
    <span style="font-weight:bold;"> Subject: {{ $probation->probationLetter->probation_letter_format_subject ?? null
        }}</span><br><br>
...
<span> These changes will come into effect from {{ $incrementSalary->increment_date ?? ''}} .</span> <span><br><br>
    ...
    <div class="col-md-12" id="draggable13">
        <img src="{{asset($probation->probationLetter->probation_letter_format_signature ?? '')}}" alt="Signature"
