                        ...
                        <div class="col-md-12">
                            <div class="card mb-2 content-box">
                                ...
                                <div class="card-header mb-10">
                                    ...
                                    <h1 class="card-title"> {{ __('Experience Letter Template') }} </h1>
                                    <nav aria-label="breadcrumb">

                                        <ol id="breadcrumb1">
                                            <li><a href="{{ route('home') }}"><span class="icon icon-home"> </span></a>
                                            </li>
                                            <li><a href="{{ route('warning-letter-formats') }}"><span
                                                        class="icon icon-list">
                                                    </span> Experience Letter Template List</a></li>
                                        </ol>
                                    </nav>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select name="warning_letter_format_footer" required>
