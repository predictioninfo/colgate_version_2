...
<section class="main-contant-section">
    ...
    <div class="employee-basic-information">
        ...
        <form method="POST" action="{{ route('salary-increment-format-edits', ['id' => $incremenrt_letters->id]) }}"
                ...
                <div class="col-md-12">
                    <div class="card mb-2 content-box">
                        ...
                        <div class="card-header mb-10">
                            ...
                            <h1 class="card-title"> {{ __('Salary Increment Letter') }} </h1>
                            <nav aria-label="breadcrumb">

                                <ol id="breadcrumb1">
                                    <li><a href="{{ route('home') }}"><span class="icon icon-home"> </span></a>
                                    </li>
                                    <li><a href="{{ route('salary-increment-letter-templates') }}"><span
                                                class="icon icon-list">
                                            </span> Salary Increment Letter List</a></li>
                                </ol>
                            </nav>
                        </div>
                                ...
                                <div class="row">
                                            ...
                                            <div class="input-group">
                                                <select name="header_id" id="" class="form-control">
                                                    ...
                                                    <option value="{{ $header->id }}" {{ $header->id ==
                                                        $incremenrt_letters->header_id ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" placeholder="Letter Subject"
                                                    ...
                                                    value="{!! strip_tags($incremenrt_letters->subject) ?? null !!}">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="">
                                            <textarea name="body" id="description" cols="50" rows="5"
                                                placeholder="Writing Somthing....">
                                                    {!! strip_tags($incremenrt_letters->body) ?? null !!}
                                                </textarea>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                <input type="" readonly class="form-control"
                                                    placeholder="The amount of your salary increased is BDT. -TK"
                                                    name="" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table class="table" style="width:10%">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="border: 1px solid black;font-size: 12px;" colspan="2">
                                                        Basic Salary</td>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <input type="" readonly class="form-control"
                                                    placeholder="These changes will come into effect from 2023-04-01"
                                                    name="" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <img id="blah" src="{{ asset($incremenrt_letters->signature) }}"
                                            ...
                                            <div class="input-group">
                                                <select name="employee_id" id="employment_type" class="form-control"
                                                    ...
                                                    <option value="{{ $employee->id }}" {{ $employee->id ==
                                                        $incremenrt_letters->emp_signature_id ? 'selected' : '' }}>
                                            ...
                                            <div class="input-group">
                                                <select name="footer_id" class="form-control">
                                                    ...
                                                    <option value="{{ $footer->id  }}" {{ $footer->id ==
                                                        $incremenrt_letters->footer_id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="">
                                            <textarea name="extra_feture" id="description1" cols="20" rows="2"
                                                placeholder="Writing Somthing....">{!! strip_tags($incremenrt_letters->extra_feture) !!}</textarea>
                                        </div>
                                    </div>
