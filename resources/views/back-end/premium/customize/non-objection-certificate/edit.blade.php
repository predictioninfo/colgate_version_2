...
@section('content')
    ...
    <section class="main-contant-section">
        ...
        <div class="employee-basic-information">
            ...
            <form method="POST" action="{{ route('noc-update', ['id' => $noc->id]) }}"
                    ...
                    <div class="col-md-12">
                        <div class="card mb-2 content-box">
                            ...
                            <div class="card-header mb-10">
                                ...
                                <h1 class="card-title"> {{ __('Non Objection Certificate') }} </h1>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" placeholder="Letter Subject"
                                                        name="non_objection_certificate_subject" required value="{!! strip_tags($noc->non_objection_certificate_subject) ?? null !!}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="">
                                                <textarea name="non_objection_certificate_body" id="description" cols="50" rows="5" placeholder="Writing Somthing....">
                                                    {!! strip_tags($noc->non_objection_certificate_body) ?? null !!}
                                                </textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <img id="blah" src="{{ asset($noc->non_objection_certificate_signature) }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <select name="non_objection_certificate_signature_emp_id" id="employment_type" class="form-control"
                                                        required>
                                                        <option value="">{{ __('Select A Signatory ') }}</option>
                                                        @foreach ($employees as $employee)
                                                            <option value="{{ $employee->id }}"
                                                                {{ $employee->id == $noc->non_objection_certificate_signature_emp_id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <select name="non_objection_certificate_footer" class="form-control"
                                                        required>
                                                        <option value="">{{ __('Select A Footer...') }}</option>
                                                        @foreach ($footers as $footer)
                                                            <option value="{{ $footer->footer_description ?? null }}"
                                                                {{ $footer->footer_description == $noc->non_objection_certificate_footer ? 'selected' : '' }}>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <textarea name="non_objection_certificate_extra_feature" id="" cols="30" rows="5"
                                                        placeholder="Writing Somthing....">{!! strip_tags($noc->non_objection_certificate_extra_feature) !!}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class=" text-left mt-4">
                                        <button type="submit" id="abcd" class="btn btn-grad ladda-button"
                                            ...
                                            <span class="ladda-label">
                                                Update </span><span class="ladda-spinner"></span></button>
                                    </div>
                                </div>
                                <div class="col-md-2">
