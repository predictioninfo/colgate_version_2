...
@endforeach
    ...
    <section class="main-contant-section">
        ...
        <form method="post" id="filter_form" class="form-horizontal container-fluid">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <button name="submit_form" id="submit_form" type="submit" class="btn btn-grad"><i class="fa fa fa-check-square-o"></i> {{trans('file.Get')}}</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
            ...
            $(document).ready(function() {
                ...
                function fill_datatable(filter_company = '', filter_employee = '', filter_month_year = $('#month_year').val()) {
                    ...
                    let table_table = $('#month_wise_attendance-table').DataTable({
                        ...
                        serverSide: true,
                        ajax: {
                            url: "{{route('monthly-attangance-getting')}}",
                            data: {
                ...
                $('#submit_form').on('click', function (e) {
                    ...
                    if (filter_company !== '' && filter_month_year !== '') {
                        ...
                        toastr.warning('Select at least one filter option')
                    }
                });
            });
