        ...
        <div class=" mb-3">
            ...
            <div class="card mb-0">
                <div class="card-header with-border">
                    <h1 class="card-title text-center">{{ 'OT Variable' }} {{ __(' List') }} </h1>
                    <ol id="breadcrumb1">
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-body">
                            <form method="post" action="{{ route('add-otallowances') }}" class="form-horizontal"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group mb-3">
                                            <label>{{ 'Add OT Variable' }} *</label>
                                            <div class="input-group-prepend">

                                            </div>
                                            <input type="number" name="ot_amount" value="" required class="form-control"
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="month" name="ot_amount_month" value="" required
                                                class="form-control">
                                        </div>
                                    </div>
                                    @endif
            ...
            <div class="content-box">
                ...
                <div class="table-responsive">
                    <table id="user-table" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            @php($i = 1)
                            @foreach ($otvariables as $otvariable)
                            <tr>

                                <td>{{ $i++ }}</td>

                                <td>{{ $otvariable->userOtVariables->first_name.'
                                    '.$otvariable->userOtVariables->last_name }}
                                </td>
                                <td>{{ $otvariable->userOtVariables->company_assigned_id }}</td>
                                <td>{{ $otvariable->other_variable_or_other_over_night_allowance_amount ?? null}}</td>
                                @if (Package::where('id', '=',
                                Auth::user()->com_pack)->whereRaw('json_contains(package_module,\'["' . $permission
                                .
                                '"]\')')->exists())
                                <td>{{$otvariable->customize_other_variable_or_other_over_night_allowance_month}}</td>
                                <td>{{$otvariable->customize_other_variable_or_other_over_night_allowance_year}}</td>
                                @else
                                <td>{{date('F',
                                    strtotime($otvariable->other_variable_or_other_over_night_allowance_month_year))}}
                                </td>
                                <td>{{date('Y',
                                    strtotime($otvariable->other_variable_or_other_over_night_allowance_month_year))}}
                                </td>
                                ...
                                <td>
                                    <a href="#" id="edit-post" class="btn edit" data-toggle="modal"
                                        data-target="#EditModal{{ $otvariable->id }}" data-id="" data-toggle="tooltip"
                                        title=" Edit " data-original-title="Edit"> <i class="fa fa-pencil-square-o"
                                            aria-hidden="true"></i></a>

                                    <a href="{{ route('delete-ot-allowances', ['id' => $otvariable->id]) }}"
                            ...
                            <div id="EditModal{{ $otvariable->id }}" class="modal fade" role="dialog">
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="post"
                                                action="{{ route('edit-ot-allowances',['id' => $otvariable->id]) }}"
                                                class="form-horizontal" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row">
                                                    <input type="hidden" name="id" value="{{ $otvariable->id }}">
                                                    <div class="col-md-12 form-group">
                                                        ...
                                                        <select name="employee_id" id="employee_id_edit"
                                                            ...
                                                            @foreach ($employees as $employee)
                                                            <option value="{{ $employee->id }}" {{  $employee->id == $otvariable->other_variable_or_other_over_night_allowance_emp_id ? 'selected' : ''}}>{{
                                                                $employee->first_name.'
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="number" name="ot_amount"
                                                                value="{{ $otvariable->other_variable_or_other_over_night_allowance_amount }}"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="month" name="ot_amount_month"
                                                                value="{{ $otvariable->other_variable_or_other_over_night_allowance_month_year }}"
                                                                required class="form-control">
                                                        </div>
                                                    </div>
                                                    @endif
