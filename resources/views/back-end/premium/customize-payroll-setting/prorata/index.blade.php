        ...
        <div class=" mb-3">
            ...
            <div class="card mb-0">
                <div class="card-header with-border">
                    <h1 class="card-title text-center">{{ 'Prorata' }} {{ __(' List') }} </h1>
                    <ol id="breadcrumb1">
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-body">
                            <form method="post" action="{{ route('add-proratas') }}" class="form-horizontal"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group mb-3">
                                            <label>{{ 'Add Prorata' }} *</label>
                                            <div class="input-group-prepend">

                                            </div>
                                            <input type="number" name="prorata_amount" value="" required
                                                class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="month" name="prorata_amount_month" value="" required
                                                class="form-control">
                                        </div>
                                    </div>
                                    @endif
            ...
            <div class="content-box">
                ...
                <div class="table-responsive">
                    <table id="user-table" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            @php($i = 1)
                            @foreach ($proratas as $prorata)
                            <tr>

                                <td>{{ $i++ }}</td>

                                <td>{{ $prorata->userProrata->first_name.' '.$prorata->userProrata->last_name }}</td>
                                <td>{{ $prorata->userProrata->company_assigned_id }}</td>
                                <td>{{ $prorata->prorata_amount ?? null}}</td>
                                @if (Package::where('id', '=',
                                Auth::user()->com_pack)->whereRaw('json_contains(package_module,\'["' . $permission
                                .
                                '"]\')')->exists())
                                <td>{{$prorata->customize_prorata_month}}</td>
                                <td>{{$prorata->customize_prorata_year}}</td>
                                @else
                                <td>{{date('F', strtotime($prorata->prorata_month_year))}}</td>
                                <td>{{date('Y', strtotime($prorata->prorata_month_year))}}</td>
                                @endif
                                <td>
                                    <a href="#" id="edit-post" class="btn edit" data-toggle="modal"
                                        data-target="#EditModal{{ $prorata->id }}" data-id="" data-toggle="tooltip"
                                        title=" Edit " data-original-title="Edit"> <i class="fa fa-pencil-square-o"
                                            aria-hidden="true"></i></a>

                                    <a href="{{ route('delete-proratas', ['id' => $prorata->id]) }}"
                            ...
                            <div id="EditModal{{ $prorata->id }}" class="modal fade" role="dialog">
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="post"
                                                action="{{ route('edit-proratas',['id' => $prorata->id]) }}"
                                                class="form-horizontal" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row">
                                                    <input type="hidden" name="id" value="{{ $prorata->id }}">
                                                    ...
                                                    <div class="col-md-12 form-group">
                                                        ...
                                                        <select name="employee_id" id="employee_id_edit"
                                                            ...
                                                            <option value="{{ $employee->id }}" {{ $employee->id ==
                                                                $prorata->prorata_emp_id ? 'selected' : '' }}>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="number" name="prorata_amount"
                                                                value="{{ $prorata->prorata_amount }}" required
                                                                class="form-control">
                                                        </div>
                                                    </div>
                                                    @if (Package::where('id', '=',
                                                    ...
                                                    <div class="col-md-6 form-group">
                                                        ...
                                                        <select name="month" class="form-control " title='Month'
                                                            ...
                                                            @foreach($customize_months as $customize_month)
                                                            <option
                                                                value="{{ $customize_month->customize_month_name }}">{{
                                                                $customize_month->customize_month_name }}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="month" name="prorata_amount_month" value=""
