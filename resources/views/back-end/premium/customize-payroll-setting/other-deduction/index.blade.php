        ...
        <div class=" mb-3">
            ...
            <div class="card mb-0">
                <div class="card-header with-border">
                    <h1 class="card-title text-center">{{ 'Other Deduction' }} {{ __(' List') }} </h1>
                    <ol id="breadcrumb1">
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-body">
                            <form method="post" action="{{ route('add-otherdeductions') }}" class="form-horizontal"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="deduction_purpose" value="" required
                                                class="form-control" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="input-group mb-3">
                                            <label>{{ 'Add Other Deduction' }} *</label>
                                            <div class="input-group-prepend">
                    ...
                    <table id="user-table" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $other_deduction->userOtherDeduction->first_name.'
                                    '.$other_deduction->userOtherDeduction->last_name }}
                                </td>
                                <td>{{ $other_deduction->userOtherDeduction->company_assigned_id }}</td>
                                <td>{{ $other_deduction->other_deduction_purpuse ?? null}}</td>
                                <td>{{ $other_deduction->other_deduction_amount ?? null}}</td>
                                @if (Package::where('id', '=',
                                Auth::user()->com_pack)->whereRaw('json_contains(package_module,\'["' . $permission
                                .
                                '"]\')')->exists())
                                <td>{{$other_deduction->customize_other_deduction_month}}</td>
                                <td>{{$other_deduction->customize_other_deduction_year}}</td>
                                @else
                                <td>{{date('F',
                                    strtotime($other_deduction->other_deduction_month_year))}}
                                </td>
                                <td>{{date('Y',
                                    strtotime($other_deduction->other_deduction_month_year))}}
                                </td>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('delete-otherdeductions', ['id' => $other_deduction->id]) }}"
                            ...
                            <div id="EditModal{{ $other_deduction->id }}" class="modal fade" role="dialog">
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="post"
                                                action="{{ route('edit-otherdeductions',['id' => $other_deduction->id]) }}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 form-group">
                                                        ...
                                                        <select name="employee_id" id="employee_id_edit"
                                                            ...
                                                            @foreach ($employees as $employee)
                                                            <option value="{{ $employee->id }}" {{ $employee->id == $other_deduction->other_deduction_emp_id ? 'selected' : '' }}>{{
                                                                $employee->first_name.'
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" name="deduction_purpose" required
                                                              value="{{ $other_deduction->other_deduction_purpuse }}" class="form-control">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            value="{{ $other_deduction->other_deduction_amount }}" class="form-control">
                                                        </div>
                                                    </div>
                                                    @if (Package::where('id', '=',
