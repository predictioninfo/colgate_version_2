        ...
        <div class=" mb-3">
            ...
            <div class="card mb-0">
                <div class="card-header with-border">
                    <h1 class="card-title text-center">{{ 'Incentive' }} {{ __(' List') }} </h1>
                    <ol id="breadcrumb1">
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-body">
                            <form method="post" action="{{ route('add-incentives') }}" class="form-horizontal"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" name="incentive_amount" value="" required
                                                class="form-control" placeholder="Incentive Amount">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="month" name="incentive_amount_month" value="" required
                                                class="form-control">
                                        </div>
                                    </div>
                                    @endif
                    ...
                    <table id="user-table" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $incentive->userIncentive->first_name.' '.$incentive->userIncentive->last_name }}
                                </td>
                                <td>{{ $incentive->userIncentive->company_assigned_id }}</td>
                                <td>{{ $incentive->incentive_amount ?? null}}</td>
                                @if (Package::where('id', '=',
                                Auth::user()->com_pack)->whereRaw('json_contains(package_module,\'["' . $permission
                                .
                                '"]\')')->exists())
                                <td>{{$incentive->customize_incentive_month}}</td>
                                <td>{{$incentive->customize_incentive_year}}</td>
                                @else
                                <td>{{date('F', strtotime($incentive->incentive_month_year))}}</td>
                                <td>{{date('Y', strtotime($incentive->incentive_month_year))}}</td>
                                @endif
                                <td>
                                    <a href="#" id="edit-post" class="btn edit" data-toggle="modal"
                                        data-target="#EditModal{{ $incentive->id }}" data-id="" data-toggle="tooltip"
                                        title=" Edit " data-original-title="Edit"> <i class="fa fa-pencil-square-o"
                                            aria-hidden="true"></i></a>

                                    <a href="{{ route('delete-incentives', ['id' => $incentive->id]) }}"
                            ...
                            <div id="EditModal{{ $incentive->id }}" class="modal fade" role="dialog">
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="post"
                                                action="{{ route('edit-incentives',['id' => $incentive->id]) }}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 form-group">
                                                        ...
                                                        <select name="employee_id" id="employee_id_edit"
                                                            ...
                                                            <option value="{{ $employee->id }}" {{ $employee->id ==
                                                                $incentive->incentive_emp_id ? 'selected' : ''  }}>{{
                                                                $employee->first_name.'
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="number" name="incentive_amount"
                                                                value="{{ $incentive->incentive_amount }}" required
                                                                class="form-control">
                                                        </div>
                                                    </div>
                                                    @if (Package::where('id', '=',
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="month" name="prorata_amount_month"
                                                                value="{{ $incentive->incentive_month_year }}" required
                                                                class="form-control">
                                                        </div>
                                                    </div>
                                                    @endif
