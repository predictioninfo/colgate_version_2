        ...
        <div class=" mb-3">
            ...
            <div class="card mb-0">
                <div class="card-header with-border">
                    <h1 class="card-title text-center">{{ 'OT Arrear' }} {{ __(' List') }} </h1>
                    <ol id="breadcrumb1">
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-body">
                            <form method="post" action="{{ route('add-ot-arreares') }}" class="form-horizontal"
            ...
            <div class="content-box">
                ...
                <div class="table-responsive">
                    <table id="user-table" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            @php($i = 1)
                            @foreach ($ot_arreares as $ot_arrear)
                            <tr>

                                <td>{{ $i++ }}</td>

                                <td>{{ $ot_arrear->userOtArrear->first_name.'
                                    '.$ot_arrear->userOtArrear->last_name }}
                                </td>
                                <td>{{ $ot_arrear->userOtArrear->company_assigned_id }}</td>
                                <td>{{ $ot_arrear->ot_arrear_amount ?? null}}</td>
                                @if (Package::where('id', '=',
                                Auth::user()->com_pack)->whereRaw('json_contains(package_module,\'["' . $permission
                                .
                                '"]\')')->exists())
                                <td>{{$ot_arrear->customize_ot_arrear_month}}</td>
                                <td>{{$ot_arrear->customize_ot_arrear_year}}</td>
                                @else
                                <td>{{date('F',
                                    strtotime($ot_arrear->customize_ot_arrear_month))}}
                                </td>
                                <td>{{date('Y',
                                    strtotime($ot_arrear->customize_ot_arrear_month))}}
                                </td>
                                ...
                                <td>
                                    <a href="#" id="edit-post" class="btn edit" data-toggle="modal"
                                        data-target="#EditModal{{ $ot_arrear->id }}" data-id="" data-toggle="tooltip"
                                        title=" Edit " data-original-title="Edit"> <i class="fa fa-pencil-square-o"
                                            aria-hidden="true"></i></a>

                                    <a href="{{ route('delete-ot-arreares', ['id' => $ot_arrear->id]) }}"
                            ...
                            <div id="EditModal{{ $ot_arrear->id }}" class="modal fade" role="dialog">
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="post"
                                                action="{{ route('edit-ot-arreares',['id' => $ot_arrear->id]) }}"
                                                class="form-horizontal" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row">
                                                    <input type="hidden" name="id" value="{{ $ot_arrear->id }}">
                                                    <div class="col-md-12 form-group">
                                                        ...
                                                        <select name="employee_id" id="employee_id_edit"
                                                            ...
                                                            @foreach ($employees as $employee)
                                                            <option value="{{ $employee->id }}" {{ $employee->id == $ot_arrear->ot_arrear_emp_id ? 'selected' : '' }}>{{
                                                                $employee->first_name.'
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="number" name="ot_amount"
                                                                value="{{ $ot_arrear->ot_arrear_amount }}"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="month" name="ot_amount_month"
                                                                value="{{ $ot_arrear->other_variable_or_other_over_night_allowance_month_year }}"
                                                                required class="form-control">
                                                        </div>
                                                    </div>
                                                    @endif
