            ...
            <div class="main-menu">
                <ul id="side-main-menu" class="side-menu list-unstyled">
                    ...
                    <li class="active"><a href="{{route('home')}}">
                            <div class="CheckStyle"><span>Dashboard</span><i style="color:white;"
                                    class="dripicons-meter"></i></div>
                        </a>
                    </li>
                    ...
                    <li
                        ...
                        <a href="#users" aria-expanded="false" data-toggle="collapse">
                            <div class="CheckStyle"><span>User</span><i style="color:white;" class="dripicons-user"></i>
                            </div>
                        </a>
                    ...
                    <li class="has-dropdown {{ (request()->is('staff*')) ? 'active' : '' }}">
                        <a href="#employees" aria-expanded="false" data-toggle="collapse">
                            <div class="CheckStyle"> <i class="dripicons-user-group"></i><span>Employees</span></div>
                        </a>
                    ...
                    <li class="has-dropdown {{ (request()->is('settings*')) ? 'active' : '' }}"><a
                            href="#Customize_settings" aria-expanded="false" data-toggle="collapse">
                            <div class="CheckStyle"> <i class="dripicons-toggles"></i><span>{{__('Customize
                                    Setting')}}</span></div>
                        </a>
                        <ul id="Customize_settings" class="collapse list-unstyled ">
                            ...
                            <li id="variable_type"><a href="{{route('variable-type')}}">{{__('Variable Type')}}</a>
                            </li>

                            <li id="variable_method"><a href="{{route('variable-method')}}">{{__('Variable
                                    Method')}}</a>
                            </li>
                            ...
                            <li id="ip_setting"><a href="{{route('salary-configs')}}">{{__('Salary Configure')}}</a></li>

                            <li id="ip_setting"><a href="{{route('salary-components')}}">{{__('Salary Component')}}</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="has-dropdown {{ (request()->is('core_hr*')) ? 'active' : '' }}"><a href="#Core_hr"
                            ...
                            <div class="CheckStyle"> <i class="dripicons-briefcase"></i><span>{{__('Core HR')}}</span>
                            </div>
                        </a>
                        <ul id="Core_hr" class="collapse list-unstyled ">


                            <li id="promotion"><a href="{{route('promotion')}}">Promotion</a>
                            </li>
                            ...
                            <li id="resignation"><a href="{{route('resignation')}}">Resignations</a>
                            </li>

                            <li id="complaint"><a href="{{route('complaint')}}">Complaints</a>
                            </li>

                            <li id="warning"><a href="{{route('warning')}}">Warnings</a>
                            </li>

                            <li id="termination"><a href="{{route('termination')}}">Terminations</a>
                            </li>

                            <li id="provident"><a href="{{route('provident-fund-member')}}">{{__('Provident Found
                                    Member')}}</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="has-dropdown {{ (request()->is('organization*')) ? 'active' : '' }}"><a
                            href="#Organization" aria-expanded="false" data-toggle="collapse">
                            <div class="CheckStyle">
                                <i class="dripicons-view-thumb"></i><span>Organization</span>
                            </div>
                        </a>
                        <ul id="Organization" class="collapse list-unstyled ">
                            ...
                            <li id="location"><a href="{{route('attandance-locations')}}">{{__('Attendance
                                    Location')}}</a></li>

                            <li id="location"><a href="{{route('login-histories')}}">{{__('Login History')}}</a></li>

                            <li id="location"><a href="{{route('login-id-locations')}}">{{__('Login ID Location')}}</a>
                            </li>
                            ...
                            <li id="location"><a href="{{route('location-sixes')}}">{{__('Location-six')}}</a></li>

                            <li id="designation"><a href="{{route('designations')}}">Designation</a>
                            </li>


                            <li id="announcements"><a href="{{route('announcement')}}">Announcements</a></li>
                    ...
                    <li class="has-dropdown {{ (request()->is('timesheet*')) ? 'active' : '' }}"><a href="#Timesheets"
                            aria-expanded="false" data-toggle="collapse">
                            <div class="CheckStyle">
                                <i class="dripicons-clock"></i><span>Timesheets</span>
                            </div>
                        </a>
                        <ul id="Timesheets" class="collapse list-unstyled ">

                            <li id="attendance"><a href="{{route('attandance')}}">Attendances</a>
                            </li>
                            <li id="date_wise_attendance"><a href="{{route('date-wise-attandance')}}"> {{__('Date wise
                                    Attendances')}}</a>
                            </li>


                            <li id="monthly_attendance"><a href="{{route('monthly-attandance')}}"> {{__('Monthly
                                    Attendances')}}</a>
                            </li>



                            <li id="update_attendance"><a href="{{route('update-attandance')}}"> {{__('Update
                                    Attendances')}}</a>
                            </li>



                            <li id="import_attendance"><a href="{{route('import-attandance')}}"> {{__('Import
                                    Attendances')}}</a>
                            </li>

                            <li id="office_shift"><a href="{{route('office-shifts')}}">{{__('Office Shift')}}</a>
                            </li>
                    ...
                    <li class="has-dropdown {{ (request()->is('payroll*')) ? 'active' : '' }}"><a href="#Payroll"
                            aria-expanded="false" data-toggle="collapse">
                            <div class="CheckStyle">
                                <i class="dripicons-wallet"></i><span>Payroll</span>
                            </div>
                        </a>
                    ...
                    <li class="has-dropdown {{ (request()->is('performance*')) ? 'active' : '' }}"><a
                            ...
                            <div class="CheckStyle"><i class="fa fa-bar-chart"></i><span>Performance</span></div>
                        </a>
                    ...
                    <li class="{{ (request()->is('calendar*')) ? 'active' : '' }}"><a href="{{route('hr-calendars')}}">
                            <div class="CheckStyle"><i class="dripicons-calendar"></i><span>{{__('HR Calendar')}}</span>
                            </div>
                        </a>
                    </li>
                    ...
                    <li class="has-dropdown {{ (request()->is('report*')) ? 'active' : '' }}"><a href="#HR_Reports"
                            aria-expanded="false" data-toggle="collapse">
                            <div class="CheckStyle">
                                <i class="dripicons-document"></i><span>{{__('HR Reports')}}</span>
                            </div>
                        </a>
                        <ul id="HR_Reports" class="collapse list-unstyled ">
                            ...
                            <li id="attendance_report"><a href="{{route('attandance-reports')}}">{{__('Attendance
                                    Report')}}</a>
                            </li>

                            <li id="training_report"><a href="{{route('training-reports')}}">{{__('Training
                                    Report')}}</a>
                            </li>

                            <li id="project_report"><a href="{{route('project-reports')}}">{{__('Project Report')}}</a>
                            </li>

                            <li id="task_report"><a href="{{route('task-reports')}}">{{__('Task Report')}}</a></li>

                            <li id="employees_report"><a href="{{route('employee-reports')}}">{{__('Employees
                                    Report')}}</a>
                            </li>

                            <li id="account_report"><a href="{{route('account-reports')}}">{{__('Account Report')}}</a>
                            </li>

                            <li id="expense_report"><a href="{{route('expense-reports')}}">{{__('Expense Report')}}</a>
                            </li>

                            <li id="deposit_report"><a href="{{route('deposite-reports')}}">{{__('Deposit Report')}}</a>
                            </li>

                            <li id="transaction_report"><a href="{{route('transaction-reports')}}">{{__('Transaction
                                    Report')}}</a>
                            </li>


                            <li id="pension_report"><a href="{{route('pension-reports')}}">{{__('Pension Report')}}</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="has-dropdown {{ (request()->is('recruitment*')) ? 'active' : '' }}"><a
                            ...
                            <div class="CheckStyle"> <i class="dripicons-user-id"></i><span>Recruitment</span></div>
                        </a>
                    ...
                    <li
                        ...
                        <a href="#Training" aria-expanded="false" data-toggle="collapse">
                            <div class="CheckStyle"> <i class="dripicons-trophy"></i><span>Training</span></div>
                        </a>
                    ...
                    <li
                        class="has-dropdown @if(request()->is('events*')){{ (request()->is('events*')) ? 'active' : '' }}@elseif(request()->is('meetings*')){{ (request()->is('meetings*')) ? 'active' : '' }}@endif">
                        <a href="#Events_Meetings" aria-expanded="false" data-toggle="collapse">
                            <div class="CheckStyle"> <i class="dripicons-to-do"></i><span>Events & Meetings</span></div>
                        </a>
                        <ul id="Events_Meetings" class="collapse list-unstyled ">

                            <li id="events"><a href="{{route('event')}}">Events</a>
                            </li>

                            <li id="meetings"><a href="{{route('meeting')}}">Meetings</a>
                            </li>
                    ...
                    <li class="has-dropdown {{ (request()->is('project-management*')) ? 'active' : '' }}"><a
                            href="#Project_Management" aria-expanded="false" data-toggle="collapse">
                            <div class="CheckStyle"> <i class="dripicons-checklist"></i><span>{{__('Project
                                    Management')}}</span></div>
                        </a>
                        <ul id="Project_Management" class="collapse list-unstyled ">

                            <li id="projects"><a href="{{route('project')}}">Projects</a>
                            </li>

                            <li id="tasks"><a href="{{route('task')}}">Tasks</a>
                            </li>
                    ...
                    <li class="{{ (request()->is('tickets*')) ? 'active' : '' }}"><a href="{{route('support-ticket')}}">
                            <div class="CheckStyle"> <i class="dripicons-ticket"></i><span>Support Tickets</span></div>
                        </a>
                    </li>
                    ...
                    <li
                        class="has-dropdown @if(request()->is('assets*')){{ (request()->is('assets*')) ? 'active' : '' }}@elseif(request()->is('dynamic_variable/assets_category*')){{ (request()->is('dynamic_variable/assets_category*')) ? 'active' : '' }}@endif">
                        <a href="#assets" aria-expanded="false" data-toggle="collapse">
                            <div class="CheckStyle"><i class="dripicons-box"></i><span>Assets</span></div>
                        </a>
                        <ul id="assets" class="collapse list-unstyled ">

                            <li id="assets_category"><a href="{{route('category')}}">Category</a>
                            </li>
                    ...
                    <li class="has-dropdown {{ (request()->is('file_manager*')) ? 'active' : '' }}"><a
                            href="#file_manager" aria-expanded="false" data-toggle="collapse">
                            <div class="CheckStyle"> <i class="dripicons-archive"></i><span>{{__('File
                                    Manager')}}</span></div>
                        </a>
                        <ul id="file_manager" class="collapse list-unstyled ">


                            <li id="files"><a href="{{route('file-managers')}}">{{__('File Manager')}}</a>
                            </li>

                            <li id="official_documents"><a href="{{route('official-document')}}">{{__('Official
                                    Documents')}}</a>
                            </li>



                            <li id="file_config"><a href="{{route('file-configurations')}}">{{__('File
                                    Configuration')}}</a>
                            </li>
