                            ...
                            <div class="card mb-2 content-box">
                                ...
                                <div class="row">
                                                ...
                                                <select class="form-control" name="appoinment_header" id="employment_type">
                                                    ...
                                                    @foreach ($headers as $headers)
                                                        <option value="{{ $headers->id }}"
                                                            {{ $headers->id == $appointments->appointment_template_header ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="">
                                            <textarea name="general_terms" id="description" cols="30" rows="5" placeholder="Writing Somthing....">  {!! html_entity_decode($appointments->appointment_template_general_terms) !!}</textarea>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="">
                                            <textarea name="description" id="description1" cols="30" rows="10">{!! html_entity_decode($appointments->appointment_template_description) !!}</textarea>
                                        </div>
                                        <span id="email_error"></span>
                                    </div>
                                                ...
                                                <select class="form-control" name="employee_id" id="employment_type"
                                                    ...
                                                    @foreach ($employees as $employee)
                                                        <option value="{{ $employee->id }}"
                                                            {{ $employee->id == $appointments->appointment_template_signature_employee_id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="website">
                                                Footer </label>
                                            <div class="input-group">
                                                <select class="form-control" name="appoinment_footer"
                                                    id="employment_type">
                                                    <option value="">{{ __('Select A Footer...') }}</option>
                                                    @foreach ($footers as $footer)
                                                        <option value="{{ $footer->footer_description ?? null }}"
                                                            {{ $footer->footer_description == $appointments->appointment_template_footer ? 'selected' : '' }}>
                                ...
                                <div class=" text-left mt-4">
                                    ...
                                    <button type="submit" id="abcd" class="btn btn-primary ladda-button"
                                        data-style="expand-right">
                                        <i class="fa fa-floppy-o" aria-hidden="true"></i>
                                        <span class="ladda-label">
                                            Save </span><span class="ladda-spinner"></span></button>
                                    <button type="submit" id="abcd" class="btn btn-success ml-3 "
                                        data-style="expand-right"><a
