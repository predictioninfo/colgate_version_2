<div class="container-fluid">
    ...
    <table class="table table-striped table-bordered">
        ...
        <tr>
            <td colspan="2">{{ $noc_employee->noctemplate->signatory->first_name }}
                {{ $noc_employee->noctemplate->signatory->last_name }}</td>
        </tr>
        <tr>
            <td colspan="2">
                {{ $noc_employee->noctemplate->signatory->userdesignation->designation_name }},<br />{{
