...
?>
    ...
    <?php
        ...
        $termination_day = date('j',strtotime(date($employee->termination_date)));
        $termination_month = date('F',strtotime(date($employee->termination_date)));
        $termination_year = date('Y',strtotime(date($employee->termination_date)));



       $emp_id =  User::where('id',$employee->termination_employee_id)->first();
        $emp_id = $emp_id->company_assigned_id;
    ...
    <div class="increment-letter" style="font-size:20px;">
        ...
        <span style="font-size:20px;"> Subject: Letter of Termination. </span>
        <br> <br>
        ...
        [{{$employee->termination_desc ?? null}}].
