...
OrgChart._defaultConfig = function(t) {
    ...
    var e = this;
    return this.config.nodes = t, this._draw(!1, OrgChart.action.init, void 0, (function() {
        e.filterUI.update()
    })), this
            ...
            this.manager.read(t, this.width(), this.height(), n, e, r, (function(t) {
                if (!a.notifierUI.show(t.notif)) {
                    ...
                    if (OrgChart.events.publish("render", [a, n]), o = n.content, t = n.res, o += a.ui.lonely(a.config), e !== OrgChart.action.exporting) {
                        ...
                        e === OrgChart.action.centerNode ? OrgChart.animate(a.getSvg(), {
                            viewbox: s
                        }, {
    ...
    return OrgChart.isNEU(e) && (e = this.searchUI._searchFields), OrgChart.isNEU(r) && (r = e), OrgChart._search.search(this.config.nodes, t, e, r, this.config.searchDisplayField, this.config.searchFieldsWeight, this.searchUI._searchFieldsAbbreviation)
...
OrgChart.attr = {}, OrgChart.attr.l = "data-l", 
...
OrgChart.ID = "id", OrgChart.PID = "pid", 
...
OrgChart.grCloseTag = "</g>", OrgChart.A5w = 420, OrgChart.A5h = 595, 
OrgChart.A4w = 595, 
OrgChart.A4h = 842, 
OrgChart.A3w = 842, 
OrgChart.A3h = 1191, 
...
OrgChart.EDITFORM_CLOSE_BTN = '<svg data-edit-from-close class="boc-edit-form-close"><path style="fill:#ffffff;" d="M21.205,5.007c-0.429-0.444-1.143-0.444-1.587,0c-0.429,0.429-0.429,1.143,0,1.571l8.047,8.047H1.111 C0.492,14.626,0,15.118,0,15.737c0,0.619,0.492,1.127,1.111,1.127h26.554l-8.047,8.032c-0.429,0.444-0.429,1.159,0,1.587 c0.444,0.444,1.159,0.444,1.587,0l9.952-9.952c0.444-0.429,0.444-1.143,0-1.571L21.205,5.007z"></path></svg>', 
OrgChart.ESCAPE_HTML = !1, 
OrgChart.VERTICAL_CHILDREN_ASSISTANT = !1, "undefined" != typeof module && (module.exports = OrgChart), 
OrgChart._intersects = function(t, e, r) {
    ...
    "bottom" == a ? n = t.rightNeighbor ? t.y + t.h + (t.rightNeighbor.y - (t.y + t.h)) / 2 : t.y + t.h + r.siblingSeparation / 2 : "top" == a && (n = t.leftNeighbor ? t.y + (t.leftNeighbor.y + t.leftNeighbor.h - t.y) / 2 : t.y - r.siblingSeparation / 2), e.push([e[e.length - 1][0], n]), e.push([t.x - r.levelSeparation / 3, n]), o = e[e.length - 1][0];
    var l = n;
    return i.p = o, i.q = n, i.s = l, i
}, OrgChart._addPointRight = function(t, e, r, i, a) {
    var n, o = e[e.length - 1][0];
    "bottom" == a ? n = t.rightNeighbor ? t.y + t.h + (t.rightNeighbor.y - (t.y + t.h)) / 2 : t.y + t.h + r.siblingSeparation / 2 : "top" == a && (n = t.leftNeighbor ? t.y + (t.leftNeighbor.y + t.leftNeighbor.h - t.y) / 2 : t.y - r.siblingSeparation / 2), e.push([e[e.length - 1][0], n]), e.push([t.x + t.w + r.levelSeparation / 3, n]), o = e[e.length - 1][0];
    var l = n;
    return i.p = o, i.q = n, i.s = l, i
    ...
    this.obj.element.appendChild(a.element), OrgChart.input.init(this.obj.element), r ? e || this._focusElement(a.focusId) : this.interval = OrgChart.animate(a.element, {
        ...
        e.preventDefault(), !1 !== OrgChart.events.publish("cancel", [i, {
            id: t
        }]) && i.hide()
    ...
    for (var n = this.obj.element.querySelectorAll("[data-input-btn]"), o = 0; o < n.length; o++) {
        n[o].addEventListener("click", (function(e) {
            e.preventDefault(), OrgChart.events.publish("element-btn-click", [i, {
    ...
    this.obj.element.querySelector("[data-add-more-fields-btn]").addEventListener("click", (function(t) {
        ...
        a.focus(), a.nextElementSibling.addEventListener("click", (function(t) {
            ...
            if (OrgChart.isNEU(r) || n) a.focus();
                ...
                a.parentNode.parentNode.parentNode.removeChild(a.parentNode.parentNode), e.parentNode.insertAdjacentHTML("beforebegin", o.html), e.style.display = "", OrgChart.input.init(e.parentNode.previousSibling), document.getElementById(o.id).focus()
            }
        }))
    ...
    var e = null;
    OrgChart.isNEU(this.obj.config.editForm.focusBinding) ? OrgChart.isNEU(t) || (e = document.getElementById(t)) : e = this.obj.element.querySelector('[data-binding="' + this.obj.config.editForm.focusBinding + '"]'), e && (e.value && e.value.length && e.setSelectionRange(e.value.length, e.value.length), e.focus())
    ...
    for (var s in a = l.menu) {
        var h = a[s].icon,
            c = a[s].text;
        void 0 === h && (h = OrgChart.icon[s] ? OrgChart.icon[s](24, 24, "#7A7A7A") : ""), "function" == typeof c && (c = c()), "function" == typeof h && (h = h()), o += "<div " + OrgChart.attr.item + '="' + s + '">' + h + "<span>&nbsp;&nbsp;" + c + "</span></div>"
    }
    if ("" != o) {
        ...
        for (var u = this.wrapper.getElementsByTagName("div"), f = 0; f < u.length; f++) {
            (s = u[f]).addEventListener("click", (function(t) {
                ...
                if (void 0 === a[o].onClick)
                    ...
                    expandChildren: !1,
                    nodeId: r
                }) : "csv" === o ? n.obj.exportCSV() : "xml" === o ? n.obj.exportXML() : "json" === o && n.obj.exportJSON();
    ...
    if (!OrgChart.isNEU(a.nodeCircleMenuButton)) {
        ...
        if (OrgChart.isNEU(p) || p.getAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id) != t) {
            ...
            for (var y in (p = document.createElementNS("http://www.w3.org/2000/svg", "g")).setAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id, t), p.setAttribute("transform", "matrix(1,0,0,1," + c + "," + d + ")"), n.appendChild(p), u.menu) {
                var x = u.menu[y].icon,
                    _ = u.menu[y].color,
                    w = u.menu[y].text;
                ...
                I.setAttribute("cx", 0), I.setAttribute("cy", 0), I.setAttribute("r", a.nodeCircleMenuButton.radius), I.setAttribute("fill", _), I.setAttribute("stroke-width", "1"), I.setAttribute("stroke", a.nodeCircleMenuButton.stroke), k.appendChild(I), k.appendChild(S), k.innerHTML += x, p.appendChild(k);
                var A = k.getElementsByTagName("svg")[0];
                if (A.setAttribute("pointer-events", "none"), A) {
                    var E = parseInt(A.getAttribute("width")),
                        L = parseInt(A.getAttribute("height"));
                    A.setAttribute("x", -E / 2), A.setAttribute("y", -L / 2)
                }
                var M = m * Math.PI / (C / 2);
                m++;
                var N = Math.cos(M) * b,
                    T = Math.sin(M) * b;
                this._buttonsInterval.push(OrgChart.animate(k, {
    ...
    this._visible = !0, this.layoutBtn.style.transform = "rotate(180deg) translateX(0px) translateY(0px)", OrgChart.animate(this.div, {
        bottom: this.obj.config.padding - 10
    }, {
        bottom: this.obj.config.padding + 135
    }, this.obj.config.anim.duration, this.obj.config.anim.func), OrgChart.animate(this.layouts, {
        bottom: -145
    }, {
        bottom: 0
    }, this.obj.config.anim.duration, this.obj.config.anim.func)
}, OrgChart.toolbarUI.prototype.hideLayout = function() {
    this._visible = !1, this.layoutBtn.style.transform = "rotate(0deg) translateX(0px) translateY(0px)", OrgChart.animate(this.div, {
        bottom: this.obj.config.padding + 135
    }, {
        bottom: this.obj.config.padding - 10
    }, this.obj.config.anim.duration, this.obj.config.anim.func), OrgChart.animate(this.layouts, {
    ...
    var n = r.offsetWidth;
    return r.style.width = "20px", OrgChart.animate(r, {
        opacity: 0,
        width: 10
    }, {
        opacity: 1,
    ...
    OrgChart._downloadFile("text/csv;charset=utf-8;", "\ufeff" + i.content, i.filename, i.openInNewTab, i.ext)
    ...
    if (!1 === OrgChart.events.publish("exportend", [this, i])) return !1;
    OrgChart._downloadFile("application/xml", i.content, i.filename, i.openInNewTab, i.ext)
    ...
    var r = {
        ...
        filename: e.filename,
        nodes: e.nodes,
        content: JSON.stringify(e.nodes)
    };
    if (!1 === OrgChart.events.publish("exportend", [this, r])) return !1;
    OrgChart._downloadFile("application/json", r.content, r.filename, r.openInNewTab, r.ext)
    ...
    if (c)
        for (var d = 0; d < c.children.length; d++) "style" == c.children[d].nodeName.toLowerCase() && (s.styles += c.children[d].outerHTML);
    ...
    if (-1 == t.indexOf("id") || -1 == t.indexOf("pid")) {
        ...
        return y.appendChild(v), r.appendChild(y), l.onclick = function(t) {
                ...
                if (p) {
                    ...
                    if (s.left || s.right || s.up || s.down) {
                        ...
                        if (null != c) {
                            ...
                            for (var A = o.getNode(c), E = OrgChart.getStParentNodes(A), L = 0; L < E.length; L++) {
                                var M = o.getNodeElement(E[L].id);
                                M && (M.style.opacity = .1)
                            }
                        ...
                        var N = (r.x - p.x) / h,
                            T = (r.y - p.y) / h;
                        if (f[4] = m + N, f[5] = C + T, !t._dragEventFired && (Math.abs(r.x - p.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(r.y - p.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE)) !1 === OrgChart.events.publish("drag", [o.nodeCircleMenuUI, {
                            from: I,
                            menuItem: n,
                            menuItemName: a
                        }]) && y(), t._dragEventFired = !0;
                        u.setAttribute("transform", "matrix(" + f.toString() + ")")
                    }
                }
            },
            y = function(e) {
                if (o.stopMove(), g.classList && (g.classList.remove("boc-cursor-grab"), g.classList.remove("boc-cursor-move"), g.classList.remove("boc-cursor-nodrop"), g.classList.remove("boc-cursor-copy")), g.removeEventListener(r.move, v), g.removeEventListener(r.up, y), r.leave && g.removeEventListener(r.leave, y), s.id == c || null == c) return g.removeChild(u), o._gragStartedId = null, void(t._dragEventFired && OrgChart.events.publish("drop", [o.nodeCircleMenuUI, {
                    from: s.id,
                    menuItemName: a,
                    menuItem: n
                }]));
    ...
    if (this.config.enableDragDrop) {
        ...
        var s = this,
            ...
            u = s.getScale(),
            f = t.cloneNode(!0);
        f.setAttribute("data-n-id", "draging"), h.insertBefore(f, h.firstChild), f.style.opacity = .7;
        var m = function(t, e) {
                if (null != t) {
                    e.classList.remove("boc-drag-over");
                ...
                if (c) {
                    ...
                    if (C.left || C.right || C.up || C.down) {
                        ...
                        s.startMove(C, (function(t) {
                            d[4] = O + t.x, d[5] = v + t.y, c.x = y - t.xWithoutScale, c.y = x - t.yWithoutScale, r.x = _ - t.xWithoutScale, r.y = w - t.yWithoutScale, f.setAttribute("transform", "matrix(" + d.toString() + ")")
                        }))
                    } else {
                        if (s.stopMove(), h.classList && (h.classList.add("boc-cursor-grab"), h.classList.remove("boc-cursor-move"), h.classList.remove("boc-cursor-nodrop"), h.classList.remove("boc-cursor-copy")), m(o, l), o = null, l = null, s.config.enableDragDrop)
                            for (; null != i && i != h;) {
                                if (i.hasAttribute && i.hasAttribute(OrgChart.attr.node_id)) {
                        ...
                        var L = (r.x - c.x) / u,
                            M = (r.y - c.y) / u;
                        if (d[4] = g + L, d[5] = p + M, !t._dragEventFired && (Math.abs(r.x - c.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(r.y - c.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE)) !1 === OrgChart.events.publish("drag", [s, k, e]) && b(), t._dragEventFired = !0;
                        f.setAttribute("transform", "matrix(" + d.toString() + ")")
                    }
                }
            },
            b = function(e) {
                if (s.stopMove(), h.classList && (h.classList.remove("boc-cursor-grab"), h.classList.remove("boc-cursor-move"), h.classList.remove("boc-cursor-nodrop"), h.classList.remove("boc-cursor-copy")), h.removeEventListener(r.move, C), h.removeEventListener(r.up, b), r.leave && h.removeEventListener(r.leave, b), n.id == o || null == o) return t._dragEventFired && OrgChart.events.publish("drop", [s, n.id, void 0, f]), h.removeChild(f), void(s._gragStartedId = null);
                var i = s.getNode(o);
                if (!1 === OrgChart.events.publish("drop", [s, n.id, i.id, f])) return m(o, l), h.removeChild(f), void(s._gragStartedId = null);
    ...
    var i;
    (OrgChart.SEARCH_CLOSE_RESULT_ON_ESCAPE_OR_CLICKOUTSIDE && this.searchUI.hide(), this.nodeMenuUI.hide(), this.nodeContextMenuUI.hide(), this.menuUI.hide(), this.nodeCircleMenuUI.hide(), r == OrgChart.action.expandCollapse && this.toggleExpandCollapse(t, e), r == OrgChart.action.edit) && ((i = this.getNode(t)) && (this.editUI.show(i.id), this.ripple(i.id, e.clientX, e.clientY)));
    ...
    var i = this;
    OrgChart.HIDE_EDIT_FORM_ON_PAN && this.editUI.hide(), OrgChart.SEARCH_CLOSE_RESULT_ON_ESCAPE_OR_CLICKOUTSIDE && this.searchUI.hide(), this.nodeMenuUI.hide(), this.nodeContextMenuUI.hide(), this.menuUI.hide(), this.nodeCircleMenuUI.hide();
    ...
    var h = function(t) {
        ...
        c = function() {
            "pan" == s.type && i.config.sticky ? setTimeout((function() {
                ...
                i._draw(!0, OrgChart.action.pan)
            }), 0), "pan" == s.type && i._changeCursorOnPanEnd(), s = null, t.removeEventListener(r.move, h), t.removeEventListener(r.up, c), r.leave && t.removeEventListener(r.leave, c), r.touchstart && t.removeEventListener(r.touchstart, c)
        };
    this.config.enablePan && (t.addEventListener(r.move, h), t.addEventListener(r.up, c), r.leave && t.addEventListener(r.leave, c), r.touchstart && t.addEventListener(r.touchstart, c))
    ...
    var i = this.getPointerElement(),
        ...
        n = a.x / e + t[0] - 16 / e,
        o = a.y / e + t[1] - 16 / e;
    i.style.display = "inherit", i.setAttribute("transform", "matrix(0,0,0,0," + n + "," + o + ")"), OrgChart.animate(i, {
        transform: [0, 0, 0, 0, n, o],
        opacity: 0
    }, {
        transform: [1 / e, 0, 0, 1 / e, n, o],
        opacity: 1
    ...
    this.obj = t, this._initSearchFields();
    var e = this,
    ...
    if (a) {
        var n = a.getBoundingClientRect(),
            o = this.obj.getSvg().getBoundingClientRect();
    ...
    var h = t.getSvg().nextSibling;
    this.obj.element.insertBefore(l, h), OrgChart.input.init(l), this.input = document.getElementById(s.id), this.xBtn.addEventListener("click", (function(t) {
        ...
        "ArrowDown" == t.key ? c() : "ArrowUp" == t.key ? d() : "Enter" == t.key ? e._enterHandler() : "Escape" == t.key ? e.hide() : e._search()
    }));
    var c = function() {
    ...
    var t = this.obj.element.querySelector('[data-selected="yes"]');
    if (t) {
        if (t.hasAttribute("data-search-item-id")) {
            var e = t.getAttribute("data-search-item-id");
            if (this.input.value != OrgChart.SEARCH_HELP_SYMBOL) 0 != OrgChart.events.publish("searchclick", [that.obj, e]) && this.obj.center(e);
    ...
    if (null == this.obj.config.searchFields) {
        this._searchFields = [];
        for (var t = 0; t < this.obj.response.allFields.length; t++) {
            var e = this.obj.response.allFields[t];
            "tags" == e || OrgChart._fieldIsImg(this.obj.config, e) || this._searchFields.push(e)
        }
    ...
    if (null == this.obj.config.searchFieldsAbbreviation) {
        ...
        for (t = 0; t < this._searchFields.length; t++) {
            for (var r = this._searchFields[t], i = 0, a = r.slice(0, i + 1).toLowerCase(); this._searchFieldsAbbreviation[a];) i++, a = r.slice(0, i + 1).toLowerCase();
            this._searchFieldsAbbreviation[a] = r
        }
    ...
    this.lastSearch = OrgChart._search.search(this.obj.config.nodes, this.input.value, this._searchFields, this._searchFields, this.obj.config.searchDisplayField, this.obj.config.searchFieldsWeight, this._searchFieldsAbbreviation)
    ...
    for (var i = this.obj.element.querySelectorAll("[data-search-item-id]"), a = 0; a < i.length; a++) i[a].addEventListener("click", (function() {
        if (this.hasAttribute("data-search-item-id")) {
            ...
            if (e.input.value != OrgChart.SEARCH_HELP_SYMBOL) {
                if (!1 !== OrgChart.events.publish("searchclick", [e.obj, t])) {
                    e.obj.center(this.getAttribute("data-search-item-id"));
                    var r = e.obj.element.querySelector('[data-selected="yes"]');
                    r && r.removeAttribute("data-selected"), this.setAttribute("data-selected", "yes"), e.input.focus()
                }
    ...
    for (var e in this._searchFieldsAbbreviation) t += `<tr data-search-item-id="${e}" style="height: 50px;"><td class="boc-search-image-td" style="text-align: center;">${e}</td><td class="boc-search-text-td">${this._searchFieldsAbbreviation[e]}</td></tr>`;
    return t += "</table>"
    ...
    this._searchAfterEnterPress && (this._searchAfterEnterPress = !1, this.obj.draw()), this.lastSearch = [], this.xBtn && (this.xBtn.style.display = "none"), this.searchTableWrapper && (this.searchTableWrapper.innerHTML = ""), this.input && (this.input.value = "", document.activeElement == this.input && this.input.blur(), document.activeElement == this.xBtn && OrgChart.input.blurHandler(this.input))
    ...
    OrgChart.state._get(this.config.state, e, r, (function(h) {
        s.state = h, s.action = a, s.actionParams = n, a != OrgChart.action.init || !s.state || n && n.method && "fit" == n.method ? (s.viewBox = i, s.vbIsInitializedFromState = !1) : (s.viewBox = s.state.vb, s.vbIsInitializedFromState = !0, Array.isArray(s.state.roots) && (s.config.roots = s.state.roots));
        var c = s.maxX,
            d = s.maxY,
            g = s.minX,
            p = s.minY,
    ...
    if (h != OrgChart.action.minimize || t.min ? h == OrgChart.action.maximize && !0 === t.min ? (c.all || c.id == t.id) && (t.min = !1) : h == OrgChart.action.exporting && !1 === c.min ? t.min = !1 : h == OrgChart.action.init && null != d && (t.min = d.min.has(t.id)) : (c.all || c.id == t.id) && (t.min = !0), !t.min)
    ...
    if (OrgChart.manager._initNode(e, r, s, i, h, c, d), e.isAssistant && (n[e.pid] || (n[e.pid] = []), n[e.pid].push(e.id)), e.subLevels > 0 && o.push(e.id), OrgChart.MIXED_LAYOUT_FOR_NODES_WITH_COLLAPSED_CHILDREN && !e.isAssistant && e.parent) {
        ...
        for (p = [], u = 0, f = 0, m = 0; m < e.parent.children.length; m++) {
            var C; - 1 == (C = e.parent.children[m]).tags.indexOf("partner") && -1 == C.tags.indexOf("left-partner") && -1 == C.tags.indexOf("right-partner") && -1 == C.tags.indexOf("assistant") && 0 == C.childrenIds.length ? p.push(C.id) : -1 != C.tags.indexOf("assistant") ? u++ : -1 == C.tags.indexOf("partner") && -1 == C.tags.indexOf("left-partner") && -1 == C.tags.indexOf("right-partner") || f++
    ...
    for (var s = r.nodes, h = [], c = 0; c < s.length; c++) {
        var d, g = s[c];
        d = OrgChart.STRING_TAGS ? g.tags ? g.tags.split(",") : [] : Array.isArray(g.tags) ? g.tags.slice(0) : [], l.filterUI.addFilterTag(g) && d.unshift("filter");
        var p = l.searchUI.addMatchTag(g.id);
        !0 === p ? d.unshift("match") : !1 === p && d.unshift("no-match");
        var u = OrgChart._getTemplate(d, r.tags, r.template),
            f = new OrgChart.node(g.id, g.pid, d, u);
        OrgChart.isNEU(g.ppid) || (f.ppid = g.ppid), OrgChart.isNEU(g.stpid) || (f.stpid = g.stpid), null != r.orderBy && (f.order = OrgChart.manager._getOrderFieldValue(g, r.orderBy)), t[g.id] = f, h.push(g.id)
    }
    ...
    if (OrgChart.manager.__createNodes(l, s, e, i, a, n, h, t), null != e.roots) {
        ...
        for (var c = 0; c < e.roots.length; c++) {
            ...
            if (d && i == OrgChart.action.centerNode) {
                ...
                for (var p = l[a.id];
                    (null != p.pid || null != p.stpid) && p != d;) p = null == p.pid && null != p.stpid ? l[p.stpid] : l[p.pid];
                g == p && (d = g)
            }
            if (d) {
                for (var u = !1, f = 0; f < s.length; f++)
                    ...
                    if (!OrgChart.isNEU(d.pid))(z = (O = l[d.pid]).childrenIds.indexOf(d.id)) > -1 && O.childrenIds.splice(z, 1);
                    s.push(d)
                }
            }
        }
    ...
    if (i == OrgChart.action.init && e.expand && e.expand.nodes && null == o)
        for (c = 0; c < e.expand.nodes.length; c++) {
            ...
            for (c = 0; c < b.length; c++)
                for (var O = l[(C = l[b[c]]).pid]; O;) m.push(O.id), null == O.pid && null != O.stpid ? (O = l[O.stpid]).min = !1 : O = l[O.pid]
        } else if (i == OrgChart.action.centerNode) {
        for (var v = l[a.id]; v;) {
            if (m.push(v.id), a.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS && v)
        ...
        if (a.options.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS)
            for (c = 0; c < v.childrenIds.length; c++) {
                (x = l[v.childrenIds[c]]).collapsed = !1;
                for (var y = 0; y < x.childrenIds.length; y++) {
                    l[x.childrenIds[y]].collapsed = !0
                }
            }
        if (a.options.parentState === OrgChart.COLLAPSE_PARENT_SUB_CHILDREN_EXCEPT_CLICKED)
            if (O = l[v.pid])
                for (c = 0; c < O.childrenIds.length; c++) {
                    var x;
                    if ((x = l[O.childrenIds[c]]) != v) {
                        x.collapsed = !1;
                        for (y = 0; y < x.childrenIds.length; y++) {
                            l[x.childrenIds[y]].collapsed = !0
                        }
                    }
                }
    } else if (i == OrgChart.action.insert)
        for (C = l[a.insertedNodeId]; C;) m.push(C.id), null == C.pid && null != C.stpid ? (C = l[C.stpid]).min = !1 : C = l[C.pid];
    var _ = [],
        w = {},
        k = [],
        S = {},
    ...
    if (i == OrgChart.action.collapse && a && Array.isArray(a.expandIds) && Array.isArray(a.collapseIds))
        for (c = 0; c < a.ids.length; c++) {
            ...
            else(C = l[a.collapseIds[c]]) && (C.collapsed = !0)
        }
    ...
    for (c = 0; c < I.length; c++) {
        ...
        for (y = 0; y < C.children.length; y++) {
            (j = C.children[y]).isAssistant ? A.push(j.id) : -1 != j.tags.indexOf("right-partner") ? (j.isPartner = 1, j.children = [], E.push(j.id)) : -1 != j.tags.indexOf("left-partner") ? (j.isPartner = 2, j.children = [], L.push(j.id)) : -1 == j.tags.indexOf("partner") || N % 2 ? -1 != j.tags.indexOf("partner") && N % 2 ? (j.isPartner = 2, j.children = [], L.push(j.id), N++) : j.parentPartner ? (M[j.parentPartner.id] || (M[j.parentPartner.id] = []), M[j.parentPartner.id].push(j.id)) : A.push(j.id) : (j.isPartner = 1, j.children = [], E.push(j.id), N++)
        }
        C.children = [];
        var H = [];
        for (y = 0; y < E.length; y++) {
            M[(j = l[E[y]]).id] ? C.children.push(j) : C.children.splice(0, 0, j);
            for (var R = 0; R < j.childrenIds.length; R++) H.push(j.childrenIds[R])
        }
        var F = [];
        for (y = 0; y < L.length; y++) {
            M[(j = l[L[y]]).id] ? C.children.push(j) : C.children.splice(0, 0, j);
            for (R = 0; R < j.childrenIds.length; R++) F.push(j.childrenIds[R])
        }
        for (y = 0; y < F.length; y++) {
            (j = l[F[y]]).collapsed || (j.parentPartner = j.parent, j.parent = C, j.isChildOfPartner = !0, C.children.push(j))
        }
        for (y = L.length - 1; y >= 0; y--)
            if (M[L[y]])
                for (f = 0; f < M[L[y]].length; f++) C.children.push(l[M[L[y]][f]]), T++, -1 == U.indexOf(L[y]) && U.push(L[y]);
        ...
        for (y = 0; y < E.length; y++)
            if (M[E[y]])
                for (f = 0; f < M[E[y]].length; f++) C.children.push(l[M[E[y]][f]]), B++, -1 == P.indexOf(E[y]) && P.push(E[y]);
        for (y = 0; y < H.length; y++) {
            (j = l[H[y]]).collapsed || (j.parentPartner = j.parent, j.parent = C, j.isChildOfPartner = !0, C.children.push(j))
        }
        C.partnerSeparation = Math.max(U.length, P.length) * e.partnerChildrenSplitSeparation + e.minPartnerSeparation, A.length || !T || B ? A.length || T || !B ? A.length || 1 != T || 1 != B ? A.length || T || B ? !A.length || T || B ? A.length && (T || B) ? C.hasPartners = 7 : C.hasPartners = 1 : C.hasPartners = 6 : C.hasPartners = 5 : C.hasPartners = 4 : C.hasPartners = 3 : C.hasPartners = 2
    }
    for (c = 0; c < k.length; c++) {
        if ((at = r[(C = l[k[c]]).lcn ? C.lcn : "base"]).layout == OrgChart.normal || !S[C.pid])
            for (y = 0; y < C.subLevels; y++) {
                var z, D = new OrgChart.node(C.id + "_sub_level_index_" + y, C.pid, [], "subLevel");
                if (OrgChart.manager._initDinamicNode(D, C.lcn), O = C.parent)(z = O.children.indexOf(C)) > -1 && (O.children.splice(z, 1), O.children.splice(z, 0, D)), D.children.push(C), D.parent = O, C.parent = D, l[D.id] = D
            }
    }
    for (var Y in w) {
        ...
        var q = [];
        for (y = O.children.length - 1; y >= 0; y--) {
            (j = O.children[y]).isAssistant ? (j.parent = null, O.children.splice(y, 1), q.splice(0, 0, j.id)) : j.isPartner || (j.parent && S[j.parent.id] && D && j.parent.id != D.id && (Object.defineProperty(S, D.id, Object.getOwnPropertyDescriptor(S, j.parent.id)), delete S[j.parent.id]), j.parent = D, D.children.unshift(j), O.children.splice(y, 1))
        }
        if (q.length % 2) {
            var X = l[q[q.length - 1]],
                $ = new OrgChart.node(X.id + "_mirror", O.pid, [], "mirror");
            OrgChart.manager._initDinamicNode($, X.lcn, !0), X._m = $.id, $.isAssistant = !0, $.w = X.w, $.h = X.h, l[$.id] = $, q.splice(q.length - 1, 0, $.id)
        }
        var V = 1;
        for (y = q.length - 1; y >= 0; y--)
            if (y % 2 && y != q.length - 1) {
                var W = new OrgChart.node(O.id + "_split_assitant_" + V, O.pid, [], "split");
                OrgChart.manager._initDinamicNode(W, O.lcn, !0), l[W.id] = W, q.splice(y, 0, W.id), V++
            } else y % 2 && q.splice(y, 0, D.id);
        for (y = 0; y < q.length; y += 3) {
            var G = null;
            G = 0 == y ? O : l[q[y - 2]];
            var K = l[q[y]],
                J = l[q[y + 1]],
    ...
    var Q = !1;
    for (var tt in r) {
        if ((at = r[tt]).layout == OrgChart.mixed || at.layout == OrgChart.tree || at.layout == OrgChart.treeRightOffset || at.layout == OrgChart.treeLeftOffset) {
            Q = !0;
            break
        }
    }
    ...
    if (Q || et) {
        ...
        for (var Y in S) {
            ...
            var at;
            if ((at = r[O.lcn ? O.lcn : "base"]).layout == OrgChart.mixed || at.layout == OrgChart.tree || at.layout == OrgChart.treeRightOffset || at.layout == OrgChart.treeLeftOffset || et)
                if (rt.pnode = O, rt.layout = at.layout, rt.childrenIds = S[Y], rt.lastChildrenPidIds = S, OrgChart.events.publish("node-layout", [t, rt]), OrgChart.events.publish("layout", [rt]), rt.layout == OrgChart.mixed) {
                    var nt = rt.childrenIds;
                    for (c = nt.length - 1; c >= 0; c--) {
                        O = (j = l[nt[c]]).parent, j.layout = OrgChart.mixed;
                        for (y = O.children.length - 1; y >= 0; y--)
                            if (j.id == O.children[y].id) {
                                O.children.splice(y, 1);
                                break
                            } if (c > 0) {
                            var ot = l[nt[c - 1]];
                            j.parent = ot, j.layout = OrgChart.mixed, ot.children.push(j)
                ...
                D = new OrgChart.node(O.id + "_split_0", it.id, [], "split");
                OrgChart.manager._initDinamicNode(D, O.lcn), l[D.id] = D, D.layout = OrgChart.tree;
                var lt = [];
                for (c = rt.childrenIds.length - 1; c >= 0; c--) {
                    for (j = l[rt.childrenIds[c]], y = 0; y < O.children.length; y++) O.children[y].id == j.id && O.children.splice(y, 1);
                    if (j.parent = null, j.layout = OrgChart.tree, rt.layout == OrgChart.treeRightOffset && lt.splice(0, 0, j.id), rt.layout == OrgChart.treeLeftOffset || rt.layout == OrgChart.treeRightOffset) {
                        var st = new OrgChart.node(j.id + "_mirror", it.id, [], "mirror");
                        OrgChart.manager._initDinamicNode(st, j.lcn), st.layout = OrgChart.tree, l[st.id] = st, lt.splice(0, 0, st.id)
                    }
                    rt.layout != OrgChart.treeRightOffset && lt.splice(0, 0, j.id)
                }
                for (V = 1, y = lt.length - 1; y >= 0; y--)
                    if (y % 2 && y != lt.length - 1) {
                        W = new OrgChart.node(O.id + "_split_" + V, it.id, [], "split");
                        OrgChart.manager._initDinamicNode(W, O.lcn), W.layout = OrgChart.tree, l[W.id] = W, lt.splice(y, 0, W.id), V++
                    } else y % 2 && lt.splice(y, 0, D.id);
                for (y = 0; y < lt.length; y += 3) {
                    G = null;
                    0 == y && (G = O);
                    K = l[lt[y]], J = l[lt[y + 1]], Z = l[lt[y + 2]];
                    0 != y && (G = l[lt[y - 3]]), 0 == y || J || (G = l[lt[y - 2]]), K.parent = G, G.children.push(K), J && (0 != y && (G = l[lt[y - 2]]), J.parent = G, G.children.push(J)), Z && (0 != y && (G = l[lt[y - 1]]), Z.parent = G, G.children.push(Z))
                }
            }
        }
    }
    if (OrgChart.VERTICAL_CHILDREN_ASSISTANT)
        for (c = 0; c < s.length; c++) OrgChart.manager._verticalAssistantIterate(s[c], l);
    return {
        nodes: l,
        roots: s,
        rootList: h
    ...
    if (C.top = l - i.padding, C.left = o - i.padding, C.bottom = n + i.padding - e / y, C.right = a + i.padding - t / y, C.maxX = a, C.minX = o, C.maxY = n, C.minY = l, 0 == h.length || null == s && !u && i.align == OrgChart.CENTER) {
        var x = Math.ceil(t / y),
            _ = Math.ceil(e / y),
            w = 0,
            k = 0;
        if (x - 2 * i.padding >= a - o) switch (w = (a + o) / 2 - x / 2, i.orientation) {
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
                w = (o - a) / 2 - x / 2
        } else switch (w = f.x - x / 2 + OrgChart.manager._getNodeWidth(f, i) / 2, i.orientation) {
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
        ...
        s = [w, k, x, _], i.sticky && (s[0] < C.left && s[0] < C.right && (s[0] = C.left > C.right ? C.right : C.left), s[0] > C.right && s[0] > C.left && (s[0] = C.left > C.right ? C.left : C.right), s[1] < C.top && s[1] < C.bottom && (s[1] = C.top > C.bottom ? C.bottom : C.top), s[1] > C.bottom && s[1] > C.top && (s[1] = C.top > C.bottom ? C.top : C.bottom))
    }
    ...
    if (c == OrgChart.action.insert || c == OrgChart.action.expand || c == OrgChart.action.collapse || c == OrgChart.action.update || c == OrgChart.action.centerNode || c == OrgChart.action.maximize) {
        var I = null;
        if (c == OrgChart.action.insert && d && null != d.insertedNodeId && null != d.insertedNodeId) I = g[d.insertedNodeId];
        else if (c == OrgChart.action.update && d && null != d.visId && null != d.visId) I = g[d.visId];
    ...
    for (var E = 0; E < h.length; E++) OrgChart.manager._iterate2(h[E], g, i, s, c, d, m, p, r, b);
    return {
        animations: b,
        boundary: C,
        viewBox: s,
    ...
    if (OrgChart.manager._isVisible(t, r, i, a)) {
        ...
        null != c && null != c.x && null != c.y && (c.x == t.x && c.y == t.y || (h[0].push(t.id), h[1].push({
    ...
    if (3 == t.children.length) OrgChart.manager._verticalAssistantIterate(t.children[0], e), OrgChart.manager._verticalAssistantIterate(t.children[2], e), OrgChart.manager._verticalAssistantIterate(t.children[1], e);
        ...
        for (r = 0; r < t.children.length; r++) OrgChart.manager._verticalAssistantIterate(t.children[r], e);
    if (t.isAssistant && t.isSplit && t.children.length) {
        ...
        var s = Math.max(o.max, l.max),
            h = [];
        for (r = 0; r < s; r++) {
            var c = new OrgChart.node(t.parent.id + "_split_assitant_level_" + r, t.pid, [], "subLevel");
            OrgChart.manager._initDinamicNode(c, t.lcn, !0), r > 0 && (h[r - 1].children.push(c), c.parent = h[r - 1]), e[c.id] = c, h.push(c)
        }
        if (h.length) {
            for (var d = h[h.length - 1], g = h[0], p = t.children.length - 1; p >= 0; p--) {
                var u = t.children[p];
                d.children.unshift(u), u.parent = d, t.children.splice(p, 1)
            }
    ...
    node: function(t, e, r, i, a, n, o, l, s, h) {
        ...
        for (var p in o) {
            ...
            if (g.value = u, g.element = c[p], g.name = f, !1 !== OrgChart.events.publish("field", [h, g]) && null != g.value && null != g.value && null != g.element) {
                m || "string" != typeof g.value || (g.value = OrgChart.wrapText(g.value, g.element));
                var C = g.element.replace("{val}", g.value);
                d += C = C.replaceAll("{ew}", t.w - (t.padding ? t.padding[1] : 0)).replaceAll("{cw}", t.w / 2).replaceAll("{randId}", OrgChart.randomId()).replaceAll("{randId2}", OrgChart.randomId())
            }
        }
        ...
        var v = "";
        t.lcn && (v = 'lcn="' + t.lcn + '"');
        var y = OrgChart.nodeOpenTag.replace("{lcn}", v).replace("{id}", t.id).replace("{class}", O).replace("{sl}", t.sl).replace("{level}", t.level).replace("{x}", b.x).replace("{y}", b.y),
            x = OrgChart._getOpacity(r, t);
        return d = (y = y.replace("{opacity}", x)) + (d += OrgChart.ui.nodeBtns(i, t, l, c, h)) + OrgChart.grCloseTag
    },
    ...
    expandCollapseBtn: function(t, e, r, i, a) {
        ...
        if (i !== OrgChart.action.exporting && !e.isSplit) {
            ...
            if (e.childrenIds.length > 0) {
                if (e.hasPartners) {
                    for (var c = !1, d = 0; d < e.childrenIds.length; d++) {
                        var g = t.getNode(e.childrenIds[d]);
                        !g || g.parentPartner || g.isPartner || (c = !0)
                    }
                    if (!c) return ""
                }
    ...
    link: function(t, e, r, i, a, n) {
        ...
        for (f = 0; f < t.children.length; f++) {
            ...
            if (m.isChildOfPartner) switch (l.orientation) {
                ...
                var y = m.isAssistant && m.rightNeighbor && m.rightNeighbor.isAssistant && m.parent == m.rightNeighbor.parent,
                    x = m.isAssistant && m.leftNeighbor && m.leftNeighbor.isAssistant && m.parent == m.leftNeighbor.parent;
                if ((y || 2 == m.layout) && m.rightNeighbor && m.rightNeighbor.isSplit) switch (l.orientation) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                    case OrgChart.orientation.bottom:
                    case OrgChart.orientation.bottom_left:
                ...
                } else if ((x || 2 == m.layout) && m.leftNeighbor && m.leftNeighbor.isSplit) switch (l.orientation) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                    case OrgChart.orientation.bottom:
                    case OrgChart.orientation.bottom_left:
                    ...
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                        if (1 == m.isPartner) b = OrgChart.ui._linkLeftToRight(t, m, s, d);
                        else if (2 == m.isPartner) b = OrgChart.ui._linkRightToLeft(t, m, s, d);
                        else {
                    ...
                    case OrgChart.orientation.right:
                    case OrgChart.orientation.right_top:
                        if (1 == m.isPartner) b = OrgChart.ui._linkTopToBottom(t, m, s, d);
                        else if (2 == m.isPartner) b = OrgChart.ui._linkBottomToTop(t, m, s, d);
                        else {
                            v = 1 == m.layout ? void 0 : C.maxX - (C.maxX - p.minX) / 2;
            ...
            if (-1 != O.indexOf("{rounded}"))
                if (b.xa == b.xb && b.xa == b.xc && b.xa == b.xd || b.ya == b.yb && b.ya == b.yc && b.ya == b.yd) O = O.replace("{rounded}", "M" + b.xa + "," + b.ya + " L" + b.xd + "," + b.yd);
                else if (Math.abs(b.xa - b.xd) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(b.xa - b.xc) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(b.xa - b.xb) <= OrgChart.LINK_ROUNDED_CORNERS) O = O.replace("{rounded}", "M" + b.xa + "," + b.ya + " L" + b.xa + "," + b.yd);
            else if (Math.abs(b.ya - b.yd) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(b.ya - b.yc) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(b.ya - b.yb) <= OrgChart.LINK_ROUNDED_CORNERS) O = O.replace("{rounded}", "M" + b.xa + "," + b.ya + " L" + b.xd + "," + b.ya);
            else {
                var _ = OrgChart.ui._roundedEdge(b.xa, b.ya, b.xb, b.yb, b.xc, b.yc),
                    w = OrgChart.ui._roundedEdge(b.xb, b.yb, b.xc, b.yc, b.xd, b.yd);
                O = O.replace("{rounded}", "M" + _.x1 + "," + _.y1 + " " + _.x2 + "," + _.y2 + " Q" + _.qx1 + "," + _.qy1 + " " + _.qx2 + "," + _.qy2 + " L" + w.x2 + "," + w.y2 + " Q" + w.qx1 + "," + w.qy1 + " " + w.qx2 + "," + w.qy2 + " L" + w.x3 + "," + w.y3)
            ...
            OrgChart.events.publish("render-link", [e, k]), h.push(k.html);
            var S = "";
            for (var I in e.config.linkBinding) {
                var A = e.config.linkBinding[I],
                    E = e._get(m.id);
                if (E) {
                    var L = E[A];
                    k.value = L, k.element = s[I], k.name = A, !1 !== OrgChart.events.publish("label", [e, k]) && (OrgChart.isNEU(k.value) || OrgChart.isNEU(k.element) || (S += k.element.replace("{val}", k.value)))
                }
            }
            "" != S && (S = OrgChart.linkFieldsOpenTag.replace("{x}", b.x).replace("{y}", b.y).replace("{rotate}", 0) + S + OrgChart.grCloseTag, h.push(S)), h.push(OrgChart.grCloseTag)
        }
        return h.join("")
    },
    ...
    _roundedEdge: function(t, e, r, i, a, n) {
        var o, l, s, h = OrgChart.LINK_ROUNDED_CORNERS,
            c = 0;
    ...
    _linkPpTop: function(t, e, r, i, a, n) {
        var o = t.ppnodes[r.id],
            ...
            d = c.x;
        return s = c.mid, OrgChart.ui._linkTopToBottom({
            x: d,
            y: l,
            w: 0,
            h: 0
    ...
    _linkPpBottom: function(t, e, r, i, a, n) {
        var o = t.ppnodes[r.id],
            ...
            c = OrgChart.ui.__linkPpBottomTop(t, e, r, s, h, o),
            d = c.x;
        return s = c.mid, OrgChart.ui._linkBottomToTop({
            x: d,
            y: l,
            w: 0,
            h: 0
    ...
    _linkPpLeft: function(t, e, r, i, a, n) {
        var o = t.ppnodes[r.id],
            ...
            d = c.y;
        return l = c.mid, OrgChart.ui._linkLeftToRight({
            x: h,
            y: d,
            w: 0,
            h: 0
    ...
    _linkPpRight: function(t, e, r, i, a, n) {
        var o = t.ppnodes[r.id],
            ...
            c = OrgChart.ui.__linkPpLeftRight(t, e, r, l, s, o),
            d = c.y;
        return l = c.mid, OrgChart.ui._linkRightToLeft({
            x: h,
            y: d,
            w: 0,
            h: 0
    ...
    var a = e.slice(0);
    e[0] < r.left && e[0] < r.right && (a[0] = r.left > r.right ? r.right : r.left), e[0] > r.right && e[0] > r.left && (a[0] = r.left > r.right ? r.left : r.right), e[1] < r.top && e[1] < r.bottom && (a[1] = r.top > r.bottom ? r.bottom : r.top), e[1] > r.bottom && e[1] > r.top && (a[1] = r.top > r.bottom ? r.top : r.bottom), e[0] !== a[0] || e[1] !== a[1] ? OrgChart.animate(t, {
        viewBox: e
    }, {
        viewBox: a
    ...
    var a, n, o = (new DOMParser).parseFromString(e, "text/xml").getElementsByTagName("text")[0],
        ...
        c = o.getAttribute(OrgChart.attr.width),
        d = o.getAttribute(OrgChart.attr.text_overflow),
        g = "http://www.w3.org/2000/svg",
        p = i.getElementsByTagName("svg")[0].getElementsByTagName("text")[0];
    d || (d = "ellipsis");
    var u = d.split("-");
    if (u.length > 1 && (a = parseInt(d.split("-")[1]), u.length > 2 && "ellipsis" == u[2] && (n = !0)), !c) return OrgChart._escapeHtml(t);
    ...
    if (-1 != d.indexOf("multiline")) {
        ...
        for (var y = 1, x = 1; x < C.length; x++) {
            ...
            if (O.firstChild.data += " " + C[x], O.getComputedTextLength() > c) {
                if (O.firstChild.data = O.firstChild.data.slice(0, _), y++, a && y > a) {
                    ...
                    break
                }(O = document.createElementNS(g, "tspan")).setAttributeNS(null, "x", l), O.setAttributeNS(null, "y", s + b * m), O.setAttributeNS(null, "text-anchor", h), v = document.createTextNode(C[x]), O.appendChild(v), p.appendChild(O), m++
            }
        }
        var k = "";
    ...
    if (this.bar) {
        var t = this.requestParams(),
            e = Math.abs(t.boundary.maxY - t.boundary.minY) * t.scale;
        switch (this.config.orientation) {
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
    ...
    if (a[2] = this.width() / s, a[3] = this.height() / s, !0 === t && s < this.config.scaleMax || !1 === t && s > this.config.scaleMin || 0 != t && 1 != t && s < this.config.scaleMax && s > this.config.scaleMin) {
        ...
        var h = this;
        r ? (clearTimeout(h._timeout), OrgChart.animate(this.getSvg(), {
    ...
    var a, n, o, l = t.element.querySelector("#boc-ppdf-size"),
        s = t.element.querySelector("#boc-ppdf-layout"),
        h = t.element.querySelector("#boc-ppdf-scale"),
        c = t.element.querySelector("#boc-ppdf-margin"),
        d = t.element.querySelector("#boc-ppdf-header"),
        g = t.element.querySelector("#boc-ppdf-footer");
    l.value = e.format, s.value = e.landscape, h.value = e.scale, c.value = e.margin, d.value = e.header, g.value = e.footer, OrgChart.animate(t.element.querySelector("#boc-ppdf-btns"), {
        margin: [0, 0, 0, -250]
    }, {
        margin: [0, 0, 0, 0]
    }, 300, OrgChart.anim.outSin, (function() {
        ...
        OrgChart.animate(t.element.querySelector("#boc-ppdf-content"), {
            opacity: 1
        }, {
            opacity: 0
    ...
    for (var r, i, a, n, o, l = "", s = 0; s < this.config.clinks.length; s++) {
        ...
        if (c && -1 != e.res.visibleNodeIds.indexOf(c.id) && (d && -1 != e.res.visibleNodeIds.indexOf(d.id))) {
            ...
            switch (this.config.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                    b <= O ? (x = 1, m.x = b + c.w / 10, C.x = O - d.w / 10) : (x = -1, m.x = b - c.w / 10, C.x = O + d.w / 10), p == f ? (x = 1, m.y = p, C.y = f) : p > f ? (m.y = p, C.y = f + d.h) : (m.y = p + c.h, C.y = f);
                    break;
                case OrgChart.orientation.bottom:
                case OrgChart.orientation.bottom_left:
                    b <= O ? (x = -1, m.x = b + c.w / 10, C.x = O + d.w / 10) : (x = 1, m.x = b - c.w / 10, C.x = O + d.w / 10), p == f ? (x = -1, m.y = p + c.h, C.y = f + d.h) : p > f ? (m.y = p, C.y = f + d.h) : (m.y = p + c.h, C.y = f);
                    break;
                case OrgChart.orientation.left:
                case OrgChart.orientation.left_top:
                    v <= y ? (x = -1, m.y = v + c.h / 5, C.y = y + d.h / 5) : (x = 1, m.y = v - c.h / 5, C.y = y + d.h / 5), g == u ? (x = -1, m.x = g, C.x = u) : g > u ? (m.x = g, C.x = u + d.w) : (m.x = g + c.w, C.x = u);
                    break;
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top:
                    v <= y ? (x = 1, m.y = v + c.h / 5, C.y = y + d.h / 5) : (x = -1, m.y = v - c.h / 5, C.y = y + d.h / 5), g == u ? (x = 1, m.x = g + c.w, C.x = u + d.w) : g > u ? (m.x = g, C.x = u + d.w) : (m.x = g + c.w, C.x = u)
            }
            var _ = A(m, C, x),
                w = h.template;
            w || (w = "orange");
    ...
    function n(e, n, o) {
        ...
        if (e.sl == n.sl) switch (h = n, g.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
            ...
            for (var m = e; null == h;) {
                var C = !1,
                    ...
                    O = b.leftNeighbor,
                    v = b.rightNeighbor;
                if (b.id == n.id ? h = b : OrgChart._intersects(b, f, t.config) && (f = OrgChart._addPoint(b, s, t.config, f, c), C = !0), b.id != n.id) {
                    for (; O;) {
                        if (O.id == n.id) {
                            h = O;
                            break
                        }
                        OrgChart._intersects(O, f, t.config) && (f = OrgChart._addPoint(O, s, t.config, f, c), C = !0), O = O.leftNeighbor
                    }
                    for (; v;) {
                        if (v.id == n.id) {
                            h = v;
                        ...
                        OrgChart._intersects(v, f, t.config) && (f = OrgChart._addPoint(v, s, t.config, f, c), C = !0), v = v.rightNeighbor
                    }
                }
                if (!C) {
                    var y = s[s.length - 1][0],
                        x = 0;
                    if (b.parent) switch (u = g.levelSeparation, b.parent.layout != OrgChart.mixed && b.parent.layout != OrgChart.tree || (u = g.mixedHierarchyNodesSeparation), g.orientation) {
                        case OrgChart.orientation.top:
                        case OrgChart.orientation.top_left:
                            x = b.parent.y + b.parent.h + u * (2 / 3);
                            break;
                        case OrgChart.orientation.bottom:
                        case OrgChart.orientation.bottom_left:
                            x = b.parent.y - u * (2 / 3);
                        ...
                        case OrgChart.orientation.left:
                        case OrgChart.orientation.left_top:
                            y = b.parent.x + b.parent.w + u * (2 / 3), x = s[s.length - 1][1];
                            break;
                        case OrgChart.orientation.right:
                        case OrgChart.orientation.right_top:
                            y = b.parent.x - u * (2 / 3), x = s[s.length - 1][1]
                    }
                    s.push([y, x])
                }
                m = b
        ...
        if (l.label) {
            ...
            r += p.label.replace("{x}", S.x).replace("{y}", S.y + N).replace("{val}", l.label)
        }
        var T = e.id,
            B = n.id;
        o && (T = n.id, B = e.id), r += ("<g " + OrgChart.attr.s_link_from + '="{from}" ' + OrgChart.attr.s_link_to + '="{to}">').replace("{from}", T).replace("{to}", B) + p.link.replaceAll("{d}", E) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + E + '" />', r += OrgChart.grCloseTag
    }
    ...
    if (t.config.miniMap && t.manager.action != OrgChart.action.move) {
        OrgChart.miniMap._settings._scale = Math.min(OrgChart.miniMap.width / (t.response.boundary.maxX - t.response.boundary.minX), OrgChart.miniMap.height / (t.response.boundary.maxY - t.response.boundary.minY)), OrgChart.miniMap._settings._translateX = -t.response.boundary.minX * OrgChart.miniMap._settings._scale + (OrgChart.miniMap.width - (t.response.boundary.maxX - t.response.boundary.minX) * OrgChart.miniMap._settings._scale) / 2, OrgChart.miniMap._settings._translateY = -t.response.boundary.minY * OrgChart.miniMap._settings._scale + (OrgChart.miniMap.height - (t.response.boundary.maxY - t.response.boundary.minY) * OrgChart.miniMap._settings._scale) / 2;
        var r = t.getViewBox();
        OrgChart.miniMap._init(t), OrgChart.miniMap._drawMainCanvas(t), OrgChart.miniMap._drawRectSelectorCanvas(t, r);
        var i, a, n, o, l = t.element.querySelector('[data-id="mini-map-focus"]'),
            s = !1,
            h = null;
        l.onmousedown = function(t) {
            var e, n, o, h = l.getBoundingClientRect(),
                c = h.left,
                d = h.top;
            if (i = parseInt(t.clientX - c), a = parseInt(t.clientY - d), e = a, n = (i - OrgChart.miniMap._settings._translateX) / OrgChart.miniMap._settings._scale, o = (e - OrgChart.miniMap._settings._translateY) / OrgChart.miniMap._settings._scale, n > r[0] && n < r[0] + r[2] && o > r[1] && o < r[1] + r[3]) return t.preventDefault(), t.stopPropagation(), void(s = !0)
            ...
            if (s) {
                ...
                var c = l.getBoundingClientRect(),
                    d = c.left,
                    g = c.top;
                n = parseInt(e.clientX - d), o = parseInt(e.clientY - g);
                var p = (n - i) / OrgChart.miniMap._settings._scale,
                    u = (o - a) / OrgChart.miniMap._settings._scale;
                r[0] = p + r[0], r[1] = u + r[1], t.setViewBox(r), h && (clearTimeout(h), h = null), h = setTimeout((function() {
                    t._draw(!0, OrgChart.action.move)
                }), 300), OrgChart.miniMap._drawRectSelectorCanvas(t, r), i = n, a = o
            }
...
})), OrgChart.miniMap = {}, OrgChart.miniMap._settings = {
    _translateX: 0,
    _translateY: 0,
    _scale: 1
    ...
    ! function t(e, n) {
        if (Array.isArray(n))
            for (var o = 0; o < n.length; o++) t(e, n[o]);
        else {
            ...
            for (o = 0; o < n.stChildrenIds.length; o++) i++, a.includes(n.id) || (1 == i ? r.fillStyle = OrgChart.miniMap.colors[0] : 2 == i ? r.fillStyle = OrgChart.miniMap.colors[1] : 3 == i && (r.fillStyle = OrgChart.miniMap.colors[2]), r.beginPath(), r.fillRect(n.x, n.y, n.w, n.h), r.strokeRect(n.x, n.y, n.w, n.h), a.push(n.id)), t(e, e.getNode(n.stChildrenIds[o])), i--;
    ...
    var a = e[0],
        ...
        o = e[2],
        l = e[3];
    i.lineWidth = .5 / OrgChart.miniMap._settings._scale, i.strokeStyle = OrgChart.miniMap.focusStroke, i.globalAlpha = 1, i.clearRect(a, n, o, l), i.strokeRect(a, n, o, l)
}, OrgChart.miniMap._initCtx = function(t, e, r) {
    var i = e.getContext("2d");
    e.width = e.width, e.height = e.height, i.clearRect(0, 0, OrgChart.miniMap.width, OrgChart.miniMap.height), i.globalAlpha = r, 1 != r && (i.fillStyle = OrgChart.miniMap.selectorBackgroundColor, i.fillRect(0, 0, OrgChart.miniMap.width, OrgChart.miniMap.height)), i.translate(OrgChart.miniMap._settings._translateX, OrgChart.miniMap._settings._translateY), i.scale(OrgChart.miniMap._settings._scale, OrgChart.miniMap._settings._scale)
}, OrgChart.miniMap._init = function(t) {
    if (!t.element.querySelector('[data-id="mini-map"]')) {
        var e = document.createElement("canvas");
        e.width = OrgChart.miniMap.width, e.height = OrgChart.miniMap.height, e.setAttribute("data-id", "mini-map-main"), e.style.display = "inline-block", e.style.backgroundColor = OrgChart.miniMap.backgroundColor, e.style.position = "absolute", e.style.top = 0, e.style.left = 0;
        ...
        var h = 0,
            ...
            d = function(t) {
                ...
                h = t.clientX, c = t.clientY
            },
            g = function() {
                document.removeEventListener("mousemove", d), document.removeEventListener("mouseup", g)
            };
        OrgChart.miniMap.draggable && i.addEventListener("mousedown", (function(t) {
            h = t.clientX, c = t.clientY, document.addEventListener("mousemove", d), document.addEventListener("mouseup", g)
        }))
    }
}, OrgChart.miniMap.colors = ["#E0E0E0", "#BDBDBD", "#9E9E9E", "#757575"], OrgChart.miniMap.selectorBackgroundColor = "white", OrgChart.miniMap.backgroundColor = "white", OrgChart.miniMap.focusStroke = "#f57c00", OrgChart.miniMap.opacity = .4, OrgChart.miniMap.border = "1px solid #aeaeae", OrgChart.miniMap.width = 250, OrgChart.miniMap.height = 140, OrgChart.miniMap.padding = 5, OrgChart.miniMap.position = {
    top: void 0,
    left: "padding",
    right: void 0,
    bottom: "padding"
}, OrgChart.miniMap.draggable = !0, OrgChart._search = {}, OrgChart._search.search = function(t, e, r, i, a, n, o) {
    var l = [],
        s = e.toLowerCase(),
        h = s.split(" ");
    if (o && h.length > 1) {
        var c = h[0];
        o[c] && (r = [o[c]], h = (s = s.replace(c, "").trim()).split(" "))
    }
    ...
    for (var o = a.length / 100, l = 0, s = 0, h = l > 0 ? 100 : 0, c = 0, d = 0; d < t.length; d++)
        for (var g = t[d], p = 0; p < n.length; p++)
            if (-1 != g.indexOf(n[p].searchPhrase)) {
                c++;
                break
            } var u = 100 / (t.length / c);
    if (n.length) {
        s = n[0].start;
    ...
    if (t.config.state) {
        ...
        }(t.roots), OrgChart.state._put(t.config.roots, t.width(), t.height(), t.response.viewBox, r, i, t.response.adjustify, t.config.state)
    }
    ...
    if (l) {
        ...
        if (l.writeToUrlParams) {
            ...
            c.has(s.paramScale) ? c.set(s.paramScale, h.scale) : c.append(s.paramScale, h.scale), c.has(s.paramX) ? c.set(s.paramX, h.x) : c.append(s.paramX, h.x), c.has(s.paramY) ? c.set(s.paramY, h.y) : c.append(s.paramY, h.y), c.has(s.paramExp) ? c.set(s.paramExp, h.exp.join("*")) : c.append(s.paramExp, h.exp.join("*")), c.has(s.paramRoots) && Array.isArray(h.roots) ? c.set(s.paramRoots, h.roots.join("*")) : Array.isArray(h.roots) && c.append(s.paramRoots, h.roots.join("*")), c.has(s.paramMin) ? c.set(s.paramMin, h.min.join("*")) : c.append(s.paramMin, h.min.join("*")), c.has(s.paramAdjustify) ? c.set(s.paramAdjustify, h.adjustify.x + "*" + h.adjustify.y) : c.append(s.paramAdjustify, h.adjustify.x + "*" + h.adjustify.y), window.history.replaceState(null, null, "?" + c)
        }
        l.writeToIndexedDB && (h.id = l.name, OrgChart.idb.put(h, (function(t) {
    ...
    if (t) {
        ...
        if (t.readFromUrlParams) {
            ...
            if (n.has(a.paramScale) && n.has(a.paramX) && n.has(a.paramY) && n.has(a.paramExp) && n.has(a.paramMin) && n.has(a.paramAdjustify)) {
                ...
                (d = [])[0] = s, d[1] = h, d[2] = e / l, d[3] = r / l, o.vb = d, o.scale = l, o.x = s, o.y = h, o.roots = null, n.has(a.paramRoots) && (o.roots = n.get(a.paramRoots).split("*")), o.exp = n.get(a.paramExp).split("*"), o.min = n.get(a.paramMin).split("*");
    ...
    try {
        ...
        r.has(e.paramScale) && r.delete(e.paramScale), r.has(e.paramX) && r.delete(e.paramX), r.has(e.paramY) && r.delete(e.paramY), r.has(e.paramExp) && r.delete(e.paramExp), r.has(e.paramRoots) && r.delete(e.paramRoots), r.has(e.paramMin) && r.delete(e.paramMin), r.has(e.paramAdjustify) && r.delete(e.paramAdjustify), window.history.replaceState(null, null, "?" + r), OrgChart.idb.delete(t, (function(e) {
    ...
    if (n || o) {
        ...
        if (l && (null != l.timer && clearInterval(l.timer), null != l.timerBack && clearInterval(l.timerBack), o.setAttribute("transform", "matrix(" + l.transformStart.toString() + ")"), OrgChart._magnify[t] = null), r) o = o.cloneNode(!0), this.getSvg().appendChild(o);
    ...
    if (i) {
        ...
        i.timerBack = OrgChart.animate(i.nodeElement, {
            transform: a
        }, {
    ...
    var n = "";
    return e.btn && (n = `<a href="#" data-input-btn="" class="boc-link boc-link-boc-button">${e.btn}</a>`), {
    ...
    if (e.binding || (e.binding = ""), e.label || (e.label = ""), "select" != e.type || Array.isArray(e.options) ? i.options = e.options : i.options = [], i.value = t && !OrgChart.isNEU(t[e.binding]) ? t[e.binding] : "", r && i.options)
        for (var a = 0; a < i.options.length; a++)
            if (i.options[a].value == i.value) {
                ...
                break
            } if (i.id = OrgChart.elements.generateId(), i.disabledAttribute = r ? "data-boc-input-disabled" : "", i.readOnlyAttribute = r ? "readonly" : "", i.id = i.id, r && OrgChart.isNEU(i.value) && (i.doNotRender = !0), r && "photo" == e.binding && (i.id = null, i.doNotRender = !0), i.binding = e.binding, i.label = e.label, i.vlidators = "", e.vlidators)
    ...
    return this.on("drop", (function(e, r, i, a) {
        var n = {
            dragId: r,
            dropId: i,
            dragNodeElement: a
...
}, OrgChart.filterUI = function() {}, OrgChart.filterUI.prototype.init = function(t) {
    this.instance = t, this.filterBy = null, this._event_id = OrgChart._guid()
    ...
    var e = this.instance.element.querySelector('[data-filter-field="' + t + '"]');
    e && e.click()
    ...
    if (this.instance.config.filterBy) {
        ...
        if ("all" == this.instance.config.filterBy)
            for (var e = 0; e < this.instance.editUI.fields.length; e++) {
                var r = this.instance.editUI.fields[e];
                "tags" != r && "id" != r && "pid" != r && "ppid" != r && "stpid" != r && (t[r] = {})
            } else if (Array.isArray(this.instance.config.filterBy))
                for (e = 0; e < this.instance.config.filterBy.length; e++) t[this.instance.config.filterBy[e]] = {};
            else if ("object" == typeof this.instance.config.filterBy)
            for (var i in this.instance.config.filterBy) t[i] = {};
        for (var a in t) {
            var n = t[a];
            for (e = 0; e < this.instance.config.nodes.length; e++) {
                var o = this.instance.config.nodes[e][a];
                null != o && (n[o] || (n[o] = {
                    checked: !0,
                    text: o
                }))
        ...
        if (null != this.filterBy)
            for (var l in t)
                if (this.filterBy[l])
                    for (var s in t[l]) this.filterBy[l][s] && (t[l][s] = this.filterBy[l][s]);
        this.filterBy = t;
        var h = this,
            c = this.instance.element.querySelector("[data-filter]");
        c && c.parentNode.removeChild(c), (c = document.createElement("div")).setAttribute("data-filter", ""), c.style.position = "absolute", c.setAttribute("class", "boc-filter"), c.style.top = this.instance.config.padding + "px", c.style.left = this.instance.config.padding + "px";
        var d = "";
        for (var l in this.filterBy) d += `<div data-filter-field="${l}">${l}</div>`;
        c.innerHTML = `<div>${d}</div>`, c.addEventListener("click", (function(t) {
            if (t.target.hasAttribute("data-filter-close") || t.target.hasAttribute("data-filter-field")) {
                for (var e = t.target.getAttribute("data-filter-field"), r = h.instance.element.querySelectorAll("[data-filter-menu]"), i = 0; i < r.length; i++) r[i].style.display = "none";
                var a = h.instance.element.querySelectorAll(".filter-field-selected");
                for (i = 0; i < a.length; i++) a[i].classList.remove("filter-field-selected");
                var n = h.instance.element.querySelector("[data-filter-close]");
                ...
                var o = h.instance.element.querySelector(`[data-filter-menu="${e}"]`);
                if (!o) {
                    var l = `<div>\n                    <input data-all type="checkbox" id="${e}" name="${e}" checked>\n                    <label for="${e}">[All]</label>\n                </div>`;
                    for (var s in h.filterBy[e]) {
                        var c = h.filterBy[e][s],
                            d = c.text;
                        null == d && (d = s), l += `<div>\n                        <input  type="checkbox" id="${s}" name="${s}" ${c.checked?"checked":""}>\n                        <label for="${s}">${d}</label>\n                    </div>`
                    }(o = document.createElement("div")).innerHTML = `<fieldset>\n                                                    <legend>Filter by ${e}:</legend>\n                                                    ${l}\n                                                </fieldset>`, o.setAttribute("data-filter-menu", e), o.classList.add("boc-filter-menu"), t.target.parentNode.parentNode.appendChild(o);
                    var g = o.querySelectorAll("input");
                    for (i = 0; i < g.length; i++) g[i].addEventListener("change", (function(t) {
                        ...
                        if (e) {
                            ...
                            if (t.target.hasAttribute("data-all")) {
                                for (var i = t.target.parentNode.parentNode.querySelectorAll("input"), a = 0; a < i.length; a++)
                                    if (i[a] != t.target)
                                        for (var n in i[a].checked = t.target.checked, h.filterBy[r]) h.filterBy[r][n].checked = t.target.checked
                            } else null != h.filterBy[r][this.name] && (h.filterBy[r][this.name].checked = this.checked);
                            h.instance.draw()
                        }
                    }))
                }
                o.style.display = "block", t.target.classList.add("filter-field-selected"), (n = document.createElement("div")).classList.add("close"), n.innerHTML = "x", n.setAttribute("data-filter-close", ""), t.target.parentNode.appendChild(n)
            }
    ...
    if (OrgChart.LIMIT_NODES || (s.l = !0), null != OrgChart.remote._fromReqDTO) OrgChart.remote._fromReqDTO(s.n, s.r, s.c, (function(e) {
        ...
        h && (h = JSON.parse(h)), h && !h.limit ? OrgChart.remote._proceed(t, h, i, r) : OrgChart.remote._findRegion((function(e) {
